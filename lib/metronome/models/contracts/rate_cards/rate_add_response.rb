    ...
    module Contracts
      module RateCards
        ...
        class RateAddResponse < Metronome::BaseModel
          ...
          # ```ruby
          # data => {
          #   rate_type: enum: Metronome::Models::Contracts::RateCards::RateAddResponse::Data::RateType,
          ...
          class Data < Metronome::BaseModel
            ...
            #   #
            #   # @param commit_rate [Metronome::Models::Contracts::RateCards::RateAddResponse::Data::CommitRate] A distinct rate on the rate card. You can choose to use this rate rather than
            ...
            # ```ruby
            # commit_rate => {
            #   rate_type: enum: Metronome::Models::Contracts::RateCards::RateAddResponse::Data::CommitRate::RateType,
            #   price: Float,
