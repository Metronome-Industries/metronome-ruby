    ...
    module Contracts
      module RateCards
        class RateAddParams < Metronome::BaseModel
          ...
          #   # @param rate_type [Symbol, Metronome::Models::Contracts::RateCards::RateAddParams::RateType]
          #   # @param starting_at [Time]
          #   # @param commit_rate [Metronome::Models::Contracts::RateCards::RateAddParams::CommitRate]
          ...
          class CommitRate < Metronome::BaseModel
            ...
            #   #   list rate when consuming a credit or commit.
            #   #
            #   # @param rate_type [Symbol, Metronome::Models::Contracts::RateCards::RateAddParams::CommitRate::RateType]
            #   # @param price [Float]
            #   # @param tiers [Array<Metronome::Models::Tier>]
            #   #
