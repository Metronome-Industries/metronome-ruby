...
module Metronome
  module Models
    module Contracts
      ...
      #   updates: -> { Metronome::ArrayOf[Metronome::Models::Contracts::ProductListResponse::Update] === _1 },
      #   **_
      # }
      # ```
      class ProductListResponse < Metronome::BaseModel
        ...
        #   # @param type [Symbol, Metronome::Models::Contracts::ProductListResponse::Type]
