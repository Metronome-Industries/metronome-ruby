  ...
  module Models
    module Contracts
      class ProductListResponse < Metronome::BaseModel
        ...
        # @!attribute type
        #
        #   @return [Symbol, Metronome::Models::Contracts::ProductListResponse::Type]
        required :type, enum: -> { Metronome::Models::Contracts::ProductListResponse::Type }

        # @!attribute updates
        #
        #   @return [Array<Metronome::Models::Contracts::ProductListResponse::Update>]
        required :updates,
                 Metronome::ArrayOf.new(-> { Metronome::Models::Contracts::ProductListResponse::Update })
        ...
        #   # @param type [String]
        #   # @param updates [Array<Metronome::Models::Contracts::ProductListResponse::Update>]
        ...
        class Update < Metronome::BaseModel
          ...
          #   #
          #   # @param composite_product_ids [Array<String>, nil]
          #   #
          #   # @param composite_tags [Array<String>, nil]
          #   #
          #   # @param exclude_free_usage [Boolean, nil]
          #   #
          #   # @param is_refundable [Boolean, nil]
          #   #
