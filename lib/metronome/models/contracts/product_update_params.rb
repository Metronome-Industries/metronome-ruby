  ...
  module Models
    module Contracts
      class ProductUpdateParams < Metronome::BaseModel
        ...
        #   #
        #   # @param billable_metric_id [String] Available for USAGE products only. If not provided, defaults to product's
        #   #   current billable metric.
        #   #
        #   # @param composite_product_ids [Array<String>] Available for COMPOSITE products only. If not provided, defaults to product's
        #   #   current composite_product_ids.
        #   #
        #   # @param composite_tags [Array<String>] Available for COMPOSITE products only. If not provided, defaults to product's
        #   #   current composite_tags.
        #   #
        #   # @param exclude_free_usage [Boolean] Beta feature only available for composite products. If true, products with $0
        ...
        #   #
        #   # @param netsuite_internal_item_id [String] If not provided, defaults to product's current netsuite_internal_item_id. This
        #   #   field's availability is dependent on your client's configuration.
        #   #
        #   # @param netsuite_overage_item_id [String] Available for USAGE and COMPOSITE products only. If not provided, defaults to
