...
module Metronome
  module Models
    class CustomerAlertListResponse < BaseModel
      # @!attribute [rw] data
      #   @return [Array<Metronome::Models::CustomerAlertListResponse::Data>]
      required :data, Metronome::ArrayOf.new(-> { Metronome::Models::CustomerAlertListResponse::Data })
      ...
      class Data < BaseModel
        # @!attribute [rw] alert
        #   @return [Metronome::Models::CustomerAlertListResponse::Data::Alert]
        required :alert, -> { Metronome::Models::CustomerAlertListResponse::Data::Alert }
        ...
        class Alert < BaseModel
          ...
          #   @return [Metronome::Models::CustomerAlertListResponse::Data::Alert::CreditType]
          optional :credit_type, -> { Metronome::Models::CustomerAlertListResponse::Data::Alert::CreditType }

          # @!attribute [rw] custom_field_filters
          #   A list of custom field filters for alert types that support advanced filtering
          #   @return [Array<Metronome::Models::CustomerAlertListResponse::Data::Alert::CustomFieldFilter>]
          optional :custom_field_filters,
                   Metronome::ArrayOf.new(-> { Metronome::Models::CustomerAlertListResponse::Data::Alert::CustomFieldFilter })
          ...
          #   @return [Metronome::Models::CustomerAlertListResponse::Data::Alert::GroupKeyFilter]
          optional :group_key_filter,
                   -> { Metronome::Models::CustomerAlertListResponse::Data::Alert::GroupKeyFilter }
