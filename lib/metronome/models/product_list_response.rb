...
module Metronome
  module Models
    class ProductListResponse < BaseModel
      ...
      #   @return [Metronome::Models::ProductListResponse::Current]
      required :current, -> { Metronome::Models::ProductListResponse::Current }

      # @!attribute [rw] initial
      #   @return [Metronome::Models::ProductListResponse::Initial]
      required :initial, -> { Metronome::Models::ProductListResponse::Initial }
      ...
      class Current < BaseModel
        ...
        #   @return [Metronome::Models::ProductListResponse::Current::QuantityConversion]
        optional :quantity_conversion, -> { Metronome::Models::ProductListResponse::Current::QuantityConversion }
        ...
        #   @return [Metronome::Models::ProductListResponse::Current::QuantityRounding]
        optional :quantity_rounding, -> { Metronome::Models::ProductListResponse::Current::QuantityRounding }
      ...
      class Initial < BaseModel
        ...
        # @!attribute [rw] quantity_conversion
        #   Optional. Only valid for USAGE products. If provided, the quantity will be converted using the provided conversion factor and operation. For example, if the operation is "multiply" and the conversion factor is 100, then the quantity will be multiplied by 100. This can be used in cases where data is sent in one unit and priced in another.  For example, data could be sent in MB and priced in GB. In this case, the conversion factor would be 1024 and the operation would be "divide".
        #   @return [Metronome::Models::ProductListResponse::Initial::QuantityConversion]
        optional :quantity_conversion, -> { Metronome::Models::ProductListResponse::Initial::QuantityConversion }

        # @!attribute [rw] quantity_rounding
        #   Optional. Only valid for USAGE products. If provided, the quantity will be rounded using the provided rounding method and decimal places. For example, if the method is "round up" and the decimal places is 0, then the quantity will be rounded up to the nearest integer.
        #   @return [Metronome::Models::ProductListResponse::Initial::QuantityRounding]
        optional :quantity_rounding, -> { Metronome::Models::ProductListResponse::Initial::QuantityRounding }
      ...
      class Update < BaseModel
        ...
        # @!attribute [rw] quantity_conversion
        #   Optional. Only valid for USAGE products. If provided, the quantity will be converted using the provided conversion factor and operation. For example, if the operation is "multiply" and the conversion factor is 100, then the quantity will be multiplied by 100. This can be used in cases where data is sent in one unit and priced in another.  For example, data could be sent in MB and priced in GB. In this case, the conversion factor would be 1024 and the operation would be "divide".
        #   @return [Metronome::Models::ProductListResponse::Update::QuantityConversion]
        optional :quantity_conversion, -> { Metronome::Models::ProductListResponse::Update::QuantityConversion }

        # @!attribute [rw] quantity_rounding
        #   Optional. Only valid for USAGE products. If provided, the quantity will be rounded using the provided rounding method and decimal places. For example, if the method is "round up" and the decimal places is 0, then the quantity will be rounded up to the nearest integer.
        #   @return [Metronome::Models::ProductListResponse::Update::QuantityRounding]
        optional :quantity_rounding, -> { Metronome::Models::ProductListResponse::Update::QuantityRounding }
