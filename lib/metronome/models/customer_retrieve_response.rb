...
module Metronome
  module Models
    class CustomerRetrieveResponse < BaseModel
      # @!attribute [rw] data
      #   @return [Metronome::Models::CustomerRetrieveResponse::Data]
      required :data, -> { Metronome::Models::CustomerRetrieveResponse::Data }
      ...
      class Data < BaseModel
        ...
        #   @return [Metronome::Models::CustomerRetrieveResponse::Data::CurrentBillableStatus]
        required :current_billable_status,
                 -> { Metronome::Models::CustomerRetrieveResponse::Data::CurrentBillableStatus }
        ...
        #   @return [Metronome::Models::CustomerRetrieveResponse::Data::CustomerConfig]
        required :customer_config, -> { Metronome::Models::CustomerRetrieveResponse::Data::CustomerConfig }
