      ...
      class Data < BaseModel
        ...
        class Amendment < BaseModel
          ...
          class ResellerRoyalty < BaseModel
            ...
            #   One of the constants defined in {Metronome::Models::ContractListResponse::Data::Amendment::ResellerRoyalty::ResellerType}
            #   @return [Symbol]
            required :reseller_type,
                     enum: -> { Metronome::Models::ContractListResponse::Data::Amendment::ResellerRoyalty::ResellerType }
        ...
        class CustomerBillingProviderConfiguration < BaseModel
          ...
          #   One of the constants defined in {Metronome::Models::ContractListResponse::Data::CustomerBillingProviderConfiguration::BillingProvider}
          #   @return [Symbol]
          required :billing_provider,
                   enum: -> { Metronome::Models::ContractListResponse::Data::CustomerBillingProviderConfiguration::BillingProvider }

          # @!attribute [rw] delivery_method
          #   One of the constants defined in {Metronome::Models::ContractListResponse::Data::CustomerBillingProviderConfiguration::DeliveryMethod}
          #   @return [Symbol]
          required :delivery_method,
                   enum: -> { Metronome::Models::ContractListResponse::Data::CustomerBillingProviderConfiguration::DeliveryMethod }
