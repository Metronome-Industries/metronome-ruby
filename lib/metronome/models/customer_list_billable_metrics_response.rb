...
module Metronome
  module Models
    class CustomerListBillableMetricsResponse < BaseModel
      ...
      #   @return [Metronome::Models::CustomerListBillableMetricsResponse::EventTypeFilter]
      optional :event_type_filter,
               -> { Metronome::Models::CustomerListBillableMetricsResponse::EventTypeFilter }
      ...
      #   @return [Array<Metronome::Models::CustomerListBillableMetricsResponse::PropertyFilter>]
