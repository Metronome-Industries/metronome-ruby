...
module Metronome
  module Models
    class CreditGrantListResponse < BaseModel
      # @!attribute [rw] data
      #   @return [Array<Metronome::Models::CreditGrantListResponse::Data>]
      required :data, Metronome::ArrayOf.new(-> { Metronome::Models::CreditGrantListResponse::Data })
      ...
      class Data < BaseModel
        ...
        #   @return [Metronome::Models::CreditGrantListResponse::Data::Balance]
        required :balance, -> { Metronome::Models::CreditGrantListResponse::Data::Balance }
        ...
        #   @return [Metronome::Models::CreditGrantListResponse::Data::GrantAmount]
        required :grant_amount, -> { Metronome::Models::CreditGrantListResponse::Data::GrantAmount }
        ...
        #   @return [Metronome::Models::CreditGrantListResponse::Data::PaidAmount]
        required :paid_amount, -> { Metronome::Models::CreditGrantListResponse::Data::PaidAmount }
        ...
        #   @return [Array<Metronome::Models::CreditGrantListResponse::Data::Product>]
        optional :products,
                 Metronome::ArrayOf.new(-> { Metronome::Models::CreditGrantListResponse::Data::Product })
