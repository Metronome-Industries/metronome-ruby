...
module Metronome
  module Models
    ...
    class ContractRetrieveResponse < Metronome::BaseModel
      ...
      # data => {
      #   id: String,
      #   amendments: -> { Metronome::ArrayOf[Metronome::Models::ContractRetrieveResponse::Data::Amendment] === _1 },
      ...
      class Data < Metronome::BaseModel
        ...
        #
        #   @return [Metronome::Models::ContractRetrieveResponse::Data::CustomerBillingProviderConfiguration, nil]
        ...
        #   # @param scheduled_charges_on_usage_invoices [Symbol, Metronome::Models::ContractRetrieveResponse::Data::ScheduledChargesOnUsageInvoices]
        ...
        class Amendment < Metronome::BaseModel
          ...
          class ResellerRoyalty < Metronome::BaseModel
            ...
            # @!parse
            #   # @param reseller_type [Symbol, Metronome::Models::ContractRetrieveResponse::Data::Amendment::ResellerRoyalty::ResellerType]
        ...
        class CustomerBillingProviderConfiguration < Metronome::BaseModel
          ...
          #   # The billing provider configuration associated with a contract.
          #   #
          #   # @param billing_provider [Symbol, Metronome::Models::ContractRetrieveResponse::Data::CustomerBillingProviderConfiguration::BillingProvider]
          #   # @param delivery_method [Symbol, Metronome::Models::ContractRetrieveResponse::Data::CustomerBillingProviderConfiguration::DeliveryMethod]
          #   #
