  ...
  module Models
    class ContractRetrieveRateScheduleResponse < BaseModel
      ...
      class Data < BaseModel
        ...
        #
        # @overload initialize(entitled: nil, list_rate: nil, product_custom_fields: nil, product_id: nil, product_name: nil, product_tags: nil, rate_card_id: nil, starting_at: nil, commit_rate: nil, ending_before: nil, override_rate: nil, pricing_group_values: nil)
        # @param entitled [Hash]
