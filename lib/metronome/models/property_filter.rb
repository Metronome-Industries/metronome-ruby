...
module Metronome
  module Models
    class PropertyFilter < Metronome::BaseModel
      ...
      #   #
      #   # @param exists [Boolean, nil] Determines whether the property must exist in the event. If true, only events
      ...
      #   #   is optional.
      #   #
      #   # @param in_values [Array<String>, nil] Specifies the allowed values for the property to match an event. An event will
      ...
      #   #   present.
      #   #
      #   # @param not_in_values [Array<String>, nil] Specifies the values that prevent an event from matching the filter. An event
