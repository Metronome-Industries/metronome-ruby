...
module Metronome
  module Models
    class PropertyFilter < BaseModel
      ...
      #
      # @overload initialize(name: nil, exists: nil, in_values: nil, not_in_values: nil)
      # @param name [String] The name of the event property.
      # @param exists [Hash] Determines whether the property must exist in the event. If true, only events
