...
module Metronome
  ...
  class BaseClient
    ...
    #
    #   @option req [Class, Metronome::Converter, Symbol, Boolean, Integer, Float] :model
    #
    # @param opts [Hash{Symbol=>Object}, Metronome::RequestOptions] .
    #
    ...
    private def build_request(req, opts)
      options = Metronome::Util.deep_merge(req, opts)
      ...
      body =
        ...
        in :get | :head | :options | :trace
          ...
          Metronome::Util.deep_merge(*values)
        end
      ...
      url = Metronome::Util.join_parsed_uri(@base_url, {**options, path: path})
