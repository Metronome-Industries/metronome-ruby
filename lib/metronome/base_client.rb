...
module Metronome
  ...
  class BaseClient
    ...
    def resolve_url(req)
      ...
      req_path, req_query = Metronome::Util.parse_uri(req.fetch(:path)).fetch_values(:path, :query)
      ...
      joined.query = Metronome::Util.encode_query(query)
      joined
    end
    ...
    private def build_request(req, opts)
      ...
      if [:get, :head, :options].include?(method)
        ...
        body = Metronome::Util.deep_merge(body, extra_body)
      end
