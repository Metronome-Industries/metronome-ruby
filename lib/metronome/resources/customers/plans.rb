  ...
  module Resources
    class Customers
      class Plans
        ...
        # @option params [Time] :starting_on RFC 3339 timestamp for when the plan becomes active for this customer. Must be
        #   at 0:00 UTC (midnight).
        # @option params [Time, nil] :ending_before RFC 3339 timestamp for when the plan ends (exclusive) for this customer. Must be
        #   at 0:00 UTC (midnight).
        # @option params [Float, nil] :net_payment_terms_days Number of days after issuance of invoice after which the invoice is due (e.g.
        #   Net 30).
        # @option params [Array<OverageRateAdjustment>, nil] :overage_rate_adjustments An optional list of overage rates that override the rates of the original plan
        #   configuration. These new rates will apply to all pricing ramps.
        # @option params [Array<PriceAdjustment>, nil] :price_adjustments A list of price adjustments can be applied on top of the pricing in the plans.
        #   See the
        #   [price adjustments documentation](https://docs.metronome.com/pricing/managing-plans/#price-adjustments)
        #   for details.
        # @option params [TrialSpec, nil] :trial_spec A custom trial can be set for the customer's plan. See the
        ...
        # @option params [Boolean, nil] :void_invoices If true, plan end date can be before the last finalized invoice date. Any
        #   invoices generated after the plan end date will be voided.
        # @option params [Boolean, nil] :void_stripe_invoices Only applicable when void_invoices is set to true. If true, for every invoice
