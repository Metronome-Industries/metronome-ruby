  ...
  class ArrayOf
    ...
    def coerce(value)
      ...
      in Enumerable unless value.is_a?(Hash)
        value.map { |item| Metronome::Converter.coerce(items_type, item) }
      else
        value
      end
    end
    ...
    def dump(value)
      ...
      case value
      in Enumerable unless value.is_a?(Hash)
        value.map { |item| Metronome::Converter.dump(items_type, item) }.to_a
      else
        value
      end
    end
  ...
  class BaseModel
    ...
    private_class_method def self.add_field(name_sym, required:, api_name:, type_info:)
      ...
      define_method(name_sym) do
        ...
        Metronome::Converter.coerce(field_type, @data[key])
