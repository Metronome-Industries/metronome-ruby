...
module Metronome
  ...
  module Converter
    # @private
    # @param spec [Proc, Class, Metronome::Converter, Hash]
    #
    # @return [Proc]
    #
    ...
    #
    # @param target [Class, Metronome::Converter]
    # @param value [Object]
    #
    # @return [Object]
    #
    ...
    def self.dump(target, value)
      case target
      in Metronome::Converter | -> { _1.is_a?(Class) && _1.include?(Metronome::Converter) }
        target.dump(value)
      else
        value
      end
  ...
  class Union
    ...
    # @private
    #
    # @param key [Symbol, Metronome::Converter, Proc]
    # @param variant [Proc, Object]
    # @param key [Symbol, nil]
    #
    # @return [void]
    ...
    private_class_method def self.variant(key, spec = {})
      variant_info =
        ...
        in Proc | Class | Metronome::Converter | Hash
  ...
  class ArrayOf
    ...
    def initialize(type_info, spec = {})
      @items_type_fn = Metronome::Converter.type_info(type_info || spec)
    end
  end
    ...
    def coerce(value)
      ...
      in Hash
        value.to_h do |key, val|
          coerced = Metronome::Converter.coerce(items_type, val)
    ...
    def dump(value)
      ...
      in Hash
        value.transform_values do |val|
          Metronome::Converter.dump(items_type, val)
        end
      else
        value
      end
  ...
  class BaseModel
    ...
    # @private
    #
    # @param data [Metronome::BaseModel, Hash{Symbol => Object}]
    #
    ...
    #
    def self.fields
      @fields ||= (superclass == Metronome::BaseModel ? {} : superclass.fields.dup)
    end
    ...
    # @param data [Hash{Symbol => Object}, Metronome::BaseModel] Raw data to initialize the model with.
    #
    def initialize(data = {})
