    ...
    module Util
      ...
      class << self
        ...
        def encode_path(path)
          path.to_s.gsub(MetronomeSDK::Internal::Util::RFC_3986_NOT_PCHARS) { ERB::Util.url_encode(_1) }
        end
      ...
      class << self
        ...
        private def write_multipart_chunk(y, boundary:, key:, val:, closing:)
          ...
          case val
          in MetronomeSDK::FilePart unless val.filename.nil?
          ...
          strio = writable_enum do |y|
            ...
            in Hash
              body.each do |key, val|
                case val
                in Array if val.all? { primitive?(_1) || MetronomeSDK::Internal::Type::FileInput === _1 }
                  val.each do |v|
