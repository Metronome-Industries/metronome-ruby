      ...
      class PooledNetRequester
        ...
        class << self
          ...
          def calibrate_socket_timeout(conn, deadline)
            timeout = deadline - MetronomeSDK::Internal::Util.monotonic_secs
        ...
        private def with_pool(url, deadline:, &blk)
          origin = MetronomeSDK::Internal::Util.uri_origin(url)
          timeout = deadline - MetronomeSDK::Internal::Util.monotonic_secs
          pool =
        ...
        def execute(request)
          ...
          enum = Enumerator.new do |y|
            ...
            raise MetronomeSDK::Errors::APIConnectionError.new(url: url, request: req)
          end
