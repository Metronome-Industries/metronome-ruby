  ...
  module Internal
    module Transport
      ...
      class BaseClient
        ...
        PLATFORM_HEADERS =
          {
            "x-stainless-arch" => MetronomeSDK::Internal::Util.arch,
            "x-stainless-lang" => "ruby",
            "x-stainless-os" => MetronomeSDK::Internal::Util.os,
            "x-stainless-package-version" => MetronomeSDK::VERSION,
        ...
        class << self
          ...
          def should_retry?(status, headers:)
            coerced = MetronomeSDK::Internal::Util.coerce_boolean(headers["x-should-retry"])
            case [coerced, status]
            in [true | false, _]
              coerced
          ...
          def follow_redirect(request, status:, response_headers:)
            ...
            location =
              Kernel.then do
                ...
                raise MetronomeSDK::Errors::APIConnectionError.new(
                  url: url,
            ...
            # from undici
            if MetronomeSDK::Internal::Util.uri_origin(url) != MetronomeSDK::Internal::Util.uri_origin(location)
          ...
          # @api private
          #
          # @param status [Integer, MetronomeSDK::Errors::APIConnectionError]
          # @param stream [Enumerable<String>, nil]
          def reap_connection!(status, stream:)
            case status
            in (..199) | (300..499)
              stream&.each { next }
            in MetronomeSDK::Errors::APIConnectionError | (500..)
              MetronomeSDK::Internal::Util.close_fused!(stream)
            else
            end
          end
        end
        ...
        # @api private
        # @return [MetronomeSDK::Internal::Transport::PooledNetRequester]
        ...
        def initialize(
          ...
          @requester = MetronomeSDK::Internal::Transport::PooledNetRequester.new
          @headers = MetronomeSDK::Internal::Util.normalized_headers(
          ...
          @base_url = MetronomeSDK::Internal::Util.parse_uri(base_url)
        ...
        #
        #   @option req [Class<MetronomeSDK::Internal::Type::BasePage>, nil] :page
        #
        #   @option req [Class<MetronomeSDK::Internal::Type::BaseStream>, nil] :stream
        #
        #   @option req [MetronomeSDK::Internal::Type::Converter, Class, nil] :model
        #
        ...
        private def build_request(req, opts)
          ...
          path = MetronomeSDK::Internal::Util.interpolate_path(uninterpolated_path)

          query = MetronomeSDK::Internal::Util.deep_merge(req[:query].to_h, opts[:extra_query].to_h)
          ...
          headers, encoded = MetronomeSDK::Internal::Util.encode_content(headers, body)
          {
            method: method,
            url: MetronomeSDK::Internal::Util.join_parsed_uri(@base_url, {**req, path: path, query: query}),
            headers: headers,
            body: encoded,
        ...
        private def send_request(request, redirect_count:, retry_count:, send_retry_header:)
          ...
          input = {
            **request.except(:timeout),
            deadline: MetronomeSDK::Internal::Util.monotonic_secs + timeout
          }
          ...
          in 300..399 if redirect_count >= self.class::MAX_REDIRECTS
            ...
            raise MetronomeSDK::Errors::APIConnectionError.new(url: url, response: response, message: message)
          in 300..399
            self.class.reap_connection!(status, stream: stream)
          ...
          in (400..) | MetronomeSDK::Errors::APIConnectionError
            self.class.reap_connection!(status, stream: stream)
        ...
        # methods call into.
        #
        # @overload request(method, path, query: {}, headers: {}, body: nil, unwrap: nil, page: nil, stream: nil, model: MetronomeSDK::Internal::Type::Unknown, options: {})
        #
        # @param method [Symbol]
        #
        ...
        #
        # @param page [Class<MetronomeSDK::Internal::Type::BasePage>, nil]
        #
        # @param stream [Class<MetronomeSDK::Internal::Type::BaseStream>, nil]
        #
        # @param model [MetronomeSDK::Internal::Type::Converter, Class, nil]
        #
        # @param options [MetronomeSDK::RequestOptions, Hash{Symbol=>Object}, nil] .
        #
        ...
        def request(req)
          ...
          model = req.fetch(:model) { MetronomeSDK::Internal::Type::Unknown }
          opts = req[:options].to_h
          MetronomeSDK::RequestOptions.validate!(opts)
        ...
        def inspect
          ...
          base_url = MetronomeSDK::Internal::Util.unparse_uri(@base_url)
          ...
          T.type_alias do
            {
              ...
              options: T.nilable(MetronomeSDK::RequestOptions::OrHash)
            }
          end
        end
