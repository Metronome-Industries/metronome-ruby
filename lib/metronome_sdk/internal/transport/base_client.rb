    ...
    module Transport
      ...
      class BaseClient
        ...
        def initialize(
          ...
          @base_url_components = MetronomeSDK::Internal::Util.parse_uri(base_url)
          @base_url = MetronomeSDK::Internal::Util.unparse_uri(@base_url_components)
        ...
        def send_request(request, redirect_count:, retry_count:, send_retry_header:)
          ...
          input = {**request.except(:timeout), deadline: MetronomeSDK::Internal::Util.monotonic_secs + timeout}
