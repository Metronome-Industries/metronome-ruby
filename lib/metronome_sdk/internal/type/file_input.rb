  ...
  module Internal
    module Type
      ...
      class FileInput
        ...
        def self.===(other)
          case other
          in Pathname | StringIO | IO | String | MetronomeSDK::FilePart
            true
          else
            false
          end
        ...
        #
        # @return [Boolean]
        def self.==(other) = other.is_a?(Class) && other <= MetronomeSDK::Internal::Type::FileInput
        ...
        class << self
          ...
          # @return [Object]
          def to_sorbet_type
            T.any(Pathname, StringIO, IO, String, MetronomeSDK::FilePart)
          end
        end
      end
    end
