    ...
    module Type
      ...
      class BaseModel
          ...
          private def add_field(name_sym, required:, type_info:, spec:)
            ...
            type_fn, info =
              ...
              in Proc | MetronomeSDK::Internal::Type::Converter | Class
                [MetronomeSDK::Internal::Type::Converter.type_info({**spec, union: type_info}), spec]
              in Hash
                [MetronomeSDK::Internal::Type::Converter.type_info(type_info), type_info]
              end

            setter = :"#{name_sym}="
            api_name = info.fetch(:api_name, name_sym)
            nilable = info.fetch(:nil?, false)
            const = required && !nilable ? info.fetch(:const, MetronomeSDK::Internal::OMIT) : MetronomeSDK::Internal::OMIT
            ...
            define_method(setter) do |value|
              target = type_fn.call
              state = MetronomeSDK::Internal::Type::Converter.new_coerce_state(translate_names: false)
              ...
              stored =
                case [target, status]
                in [MetronomeSDK::Internal::Type::Converter | Symbol, true]
                  coerced
                else
                  value
                end
            ...
            define_method(name_sym) do
              ...
              in true | false if MetronomeSDK::Internal::Type::Converter === target
                @data.fetch(name_sym)
              in ::StandardError => e
                raise MetronomeSDK::Errors::ConversionError.new(
                  on: self.class,
                  method: __method__,
                  target: target,
                ...
                Kernel.then do
                  value = @data.fetch(name_sym) { const == MetronomeSDK::Internal::OMIT ? nil : const }
                  state = MetronomeSDK::Internal::Type::Converter.new_coerce_state(translate_names: false)
                  if (nilable || !required) && value.nil?
                    nil
                  else
                    MetronomeSDK::Internal::Type::Converter.coerce(
        ...
        class << self
          # @api private
          #
          # @param value [MetronomeSDK::Internal::Type::BaseModel, Hash{Object=>Object}, Object]
          #
