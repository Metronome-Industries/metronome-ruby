...
module MetronomeSDK
  module Internal
    module Type
      ...
      #   when MetronomeSDK::Models::V1::ContractListBalancesResponse::UnionMember0
      #     puts(contract_list_balances_response.id)
      #   when MetronomeSDK::Models::V1::ContractListBalancesResponse::UnionMember1
      ...
      module Union
        ...
        # @api private
        #
        # @param key [Symbol, Hash{Symbol=>Object}, Proc, MetronomeSDK::Internal::Type::Converter, Class]
        #
        ...
        # @param value [Object]
        #
        # @return [MetronomeSDK::Internal::Type::Converter, Class, nil]
        private def resolve_variant(value)
          case [@discriminator, value]
          in [_, MetronomeSDK::Internal::Type::BaseModel]
            value.class
          in [Symbol, Hash]
            key = value.fetch(@discriminator) do
              value.fetch(@discriminator.to_s, MetronomeSDK::Internal::OMIT)
            end
        ...
        # @return [Boolean]
        def ==(other)
          MetronomeSDK::Internal::Type::Union === other && other.derefed_variants == derefed_variants
        end
        ...
        def coerce(value, state:)
          if (target = resolve_variant(value))
            return MetronomeSDK::Internal::Type::Converter.coerce(target, value, state: state)
          end
          ...
          known_variants.each do |_, variant_fn|
            ...
            coerced = MetronomeSDK::Internal::Type::Converter.coerce(target, value, state: state)
        ...
        def dump(value, state:)
          if (target = resolve_variant(value))
            return MetronomeSDK::Internal::Type::Converter.dump(target, value, state: state)
          end

          known_variants.each do
            target = _2.call
            if target === value
              return MetronomeSDK::Internal::Type::Converter.dump(
                target,
                value,
                state: state
              )
        ...
        def inspect(depth: 0)
          ...
          members = variants.map { MetronomeSDK::Internal::Type::Converter.inspect(_1, depth: depth.succ) }
