    ...
    module Type
      ...
      class HashOf
        ...
        def ==(other)
          ...
          other.is_a?(MetronomeSDK::Internal::Type::HashOf) && other.nilable? == nilable? && other.item_type == item_type
            ...
            .to_h do |key, val|
              ...
              v =
                ...
                in [true, nil]
                  ...
                  MetronomeSDK::Internal::Type::Converter.coerce(target, val, state: state)
                end
