...
module MetronomeSDK
  module Models
    module V1
      module Customers
        # @see MetronomeSDK::Resources::V1::Customers::NamedSchedules#update
        class NamedScheduleUpdateParams < MetronomeSDK::Internal::Type::BaseModel
          ...
          # @!method initialize(customer_id:, schedule_name:, starting_at:, value:, ending_before: nil, request_options: {})
