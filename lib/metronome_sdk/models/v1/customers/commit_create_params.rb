      ...
      module Customers
        ...
        class CommitCreateParams < MetronomeSDK::Internal::Type::BaseModel
          ...
          class AccessSchedule < MetronomeSDK::Internal::Type::BaseModel
            ...
            #   omitted.
            #
            #   @return [Symbol, MetronomeSDK::Models::V1::Customers::CommitCreateParams::AccessSchedule::AccessType, nil]
            optional :access_type,
                     enum: -> { MetronomeSDK::V1::Customers::CommitCreateParams::AccessSchedule::AccessType }
            ...
            #   Some parameter documentations has been truncated, see
            #   {MetronomeSDK::Models::V1::Customers::CommitCreateParams::AccessSchedule} for
            #   more details.
            #
            #   Schedule for distributing the commit to the customer. For "POSTPAID" commits
            #   only one schedule item is allowed and amount must match invoice_schedule total.
            ...
            #
            #   @param access_type [Symbol, MetronomeSDK::Models::V1::Customers::CommitCreateParams::AccessSchedule::AccessType] Determines how the balance is drawn down. `SPEND` deducts the dollar cost of usa
            #
            ...
            # omitted.
            #
            # @see MetronomeSDK::Models::V1::Customers::CommitCreateParams::AccessSchedule#access_type
            module AccessType
