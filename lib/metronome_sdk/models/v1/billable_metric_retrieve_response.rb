    ...
    module V1
      ...
      class BillableMetricRetrieveResponse < MetronomeSDK::Internal::Type::BaseModel
        ...
        class Data < MetronomeSDK::Internal::Type::BaseModel
          ...
          #
          #   @return [MetronomeSDK::Models::V1::BillableMetricRetrieveResponse::Data::EventTypeFilter, nil]
          ...
          #   billable metric.
          #
          #   @return [Array<MetronomeSDK::Models::V1::BillableMetricRetrieveResponse::Data::PropertyFilter>, nil]
          optional :property_filters,
                   -> { MetronomeSDK::Internal::Type::ArrayOf[MetronomeSDK::Models::V1::BillableMetricRetrieveResponse::Data::PropertyFilter] }
          ...
          #
          #   @param event_type_filter [MetronomeSDK::Models::V1::BillableMetricRetrieveResponse::Data::EventTypeFilter] An optional filtering rule to match the 'event_type' property of an event.
          #
          #   @param group_keys [Array<Array<String>>] Property names that are used to group usage costs on an invoice. Each entry repr
          #
          #   @param property_filters [Array<MetronomeSDK::Models::V1::BillableMetricRetrieveResponse::Data::PropertyFilter>] A list of filters to match events to this billable metric. Each filter defines a
          #
          ...
          # @see MetronomeSDK::Models::V1::BillableMetricRetrieveResponse::Data#event_type_filter
