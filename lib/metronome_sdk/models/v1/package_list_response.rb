  ...
  module Models
    module V1
      ...
      class PackageListResponse < MetronomeSDK::Internal::Type::BaseModel
        ...
        #
        #   @return [Array<MetronomeSDK::Models::V1::PackageListResponse::SpendTracker>, nil]
        optional :spend_trackers,
                 -> { MetronomeSDK::Internal::Type::ArrayOf[MetronomeSDK::Models::V1::PackageListResponse::SpendTracker] }
        ...
        #
        #   @param spend_trackers [Array<MetronomeSDK::Models::V1::PackageListResponse::SpendTracker>]
        #
        ...
        class Commit < MetronomeSDK::Internal::Type::BaseModel
          ...
          class AccessSchedule < MetronomeSDK::Internal::Type::BaseModel
            ...
            #
            #   @return [Symbol, MetronomeSDK::Models::V1::PackageListResponse::Commit::AccessSchedule::AccessType, nil]
            optional :access_type,
                     enum: -> { MetronomeSDK::Models::V1::PackageListResponse::Commit::AccessSchedule::AccessType }

            # @!method initialize(credit_type:, schedule_items:, access_type: nil)
            #   Some parameter documentations has been truncated, see
            #   {MetronomeSDK::Models::V1::PackageListResponse::Commit::AccessSchedule} for more
            #   details.
            #
            #   The schedule that the customer will gain access to the credits purposed with
            #   this commit.
            ...
            #
            #   @param access_type [Symbol, MetronomeSDK::Models::V1::PackageListResponse::Commit::AccessSchedule::AccessType] Indicates how the balance is drawn down. `SPEND` deducts the dollar cost of usag
            ...
            # usage. `QUANTITY` deducts the number of units used.
            #
            # @see MetronomeSDK::Models::V1::PackageListResponse::Commit::AccessSchedule#access_type
            module AccessType
              extend MetronomeSDK::Internal::Type::Enum
        ...
        class Credit < MetronomeSDK::Internal::Type::BaseModel
          ...
          class AccessSchedule < MetronomeSDK::Internal::Type::BaseModel
            ...
            #   usage. `QUANTITY` deducts the number of units used.
            #
            #   @return [Symbol, MetronomeSDK::Models::V1::PackageListResponse::Credit::AccessSchedule::AccessType, nil]
            optional :access_type,
                     enum: -> { MetronomeSDK::Models::V1::PackageListResponse::Credit::AccessSchedule::AccessType }

            # @!method initialize(credit_type:, schedule_items:, access_type: nil)
            #   Some parameter documentations has been truncated, see
            #   {MetronomeSDK::Models::V1::PackageListResponse::Credit::AccessSchedule} for more
            #   details.
            #
            #   @param credit_type [MetronomeSDK::Models::CreditTypeData]
            #
            ...
            #
            #   @param access_type [Symbol, MetronomeSDK::Models::V1::PackageListResponse::Credit::AccessSchedule::AccessType] Indicates how the balance is drawn down. `SPEND` deducts the dollar cost of usag
            ...
            # usage. `QUANTITY` deducts the number of units used.
            #
            # @see MetronomeSDK::Models::V1::PackageListResponse::Credit::AccessSchedule#access_type
            module AccessType
              extend MetronomeSDK::Internal::Type::Enum
        ...
        class RecurringCommit < MetronomeSDK::Internal::Type::BaseModel
          ...
          class AccessAmount < MetronomeSDK::Internal::Type::BaseModel
            ...
            #
            #   @return [Symbol, MetronomeSDK::Models::V1::PackageListResponse::RecurringCommit::AccessAmount::AccessType, nil]
            optional :access_type,
                     enum: -> { MetronomeSDK::Models::V1::PackageListResponse::RecurringCommit::AccessAmount::AccessType }
            ...
            #   @param unit_price [Float]
            #
            #   @param access_type [Symbol, MetronomeSDK::Models::V1::PackageListResponse::RecurringCommit::AccessAmount::AccessType] Indicates how the balance of child commits is drawn down. `SPEND` deducts the do
            #
            #   @param quantity [Float]
            ...
            # dollar cost of usage. `QUANTITY` deducts the number of units used.
            #
            # @see MetronomeSDK::Models::V1::PackageListResponse::RecurringCommit::AccessAmount#access_type
            module AccessType
              extend MetronomeSDK::Internal::Type::Enum
        ...
        class RecurringCredit < MetronomeSDK::Internal::Type::BaseModel
          ...
          class AccessAmount < MetronomeSDK::Internal::Type::BaseModel
            ...
            #   dollar cost of usage. `QUANTITY` deducts the number of units used.
            #
            #   @return [Symbol, MetronomeSDK::Models::V1::PackageListResponse::RecurringCredit::AccessAmount::AccessType, nil]
            optional :access_type,
                     enum: -> { MetronomeSDK::Models::V1::PackageListResponse::RecurringCredit::AccessAmount::AccessType }
            ...
            #   @param unit_price [Float]
            #
            #   @param access_type [Symbol, MetronomeSDK::Models::V1::PackageListResponse::RecurringCredit::AccessAmount::AccessType] Indicates how the balance of child commits is drawn down. `SPEND` deducts the do
            #
            #   @param quantity [Float]
            ...
            # dollar cost of usage. `QUANTITY` deducts the number of units used.
            #
            # @see MetronomeSDK::Models::V1::PackageListResponse::RecurringCredit::AccessAmount#access_type
            module AccessType
              extend MetronomeSDK::Internal::Type::Enum
        ...
        class SpendTracker < MetronomeSDK::Internal::Type::BaseModel
          ...
          #
          #   @return [Array<MetronomeSDK::Models::V1::PackageListResponse::SpendTracker::ApplicableSpendSpecifier>]
          required :applicable_spend_specifiers,
                   -> { MetronomeSDK::Internal::Type::ArrayOf[MetronomeSDK::Models::V1::PackageListResponse::SpendTracker::ApplicableSpendSpecifier] }
          ...
          #
          #   @return [Symbol, MetronomeSDK::Models::V1::PackageListResponse::SpendTracker::ResetFrequency]
          required :reset_frequency,
                   enum: -> { MetronomeSDK::Models::V1::PackageListResponse::SpendTracker::ResetFrequency }
          ...
          #
          #   @param applicable_spend_specifiers [Array<MetronomeSDK::Models::V1::PackageListResponse::SpendTracker::ApplicableSpendSpecifier>]
          #
          #   @param credit_type_id [String]
          #
          #   @param reset_frequency [Symbol, MetronomeSDK::Models::V1::PackageListResponse::SpendTracker::ResetFrequency]

          class ApplicableSpendSpecifier < MetronomeSDK::Internal::Type::BaseModel
            # @!attribute sources
            #
            #   @return [Array<Symbol, MetronomeSDK::Models::V1::PackageListResponse::SpendTracker::ApplicableSpendSpecifier::Source>]
            required :sources,
                     -> { MetronomeSDK::Internal::Type::ArrayOf[enum: MetronomeSDK::Models::V1::PackageListResponse::SpendTracker::ApplicableSpendSpecifier::Source] }

            # @!attribute spend_type
            #
            #   @return [Symbol, MetronomeSDK::Models::V1::PackageListResponse::SpendTracker::ApplicableSpendSpecifier::SpendType]
            required :spend_type,
                     enum: -> { MetronomeSDK::Models::V1::PackageListResponse::SpendTracker::ApplicableSpendSpecifier::SpendType }

            # @!attribute discounted
            #
            #   @return [Symbol, MetronomeSDK::Models::V1::PackageListResponse::SpendTracker::ApplicableSpendSpecifier::Discounted, nil]
            optional :discounted,
                     enum: -> { MetronomeSDK::Models::V1::PackageListResponse::SpendTracker::ApplicableSpendSpecifier::Discounted }

            # @!method initialize(sources:, spend_type:, discounted: nil)
            #   @param sources [Array<Symbol, MetronomeSDK::Models::V1::PackageListResponse::SpendTracker::ApplicableSpendSpecifier::Source>]
            #   @param spend_type [Symbol, MetronomeSDK::Models::V1::PackageListResponse::SpendTracker::ApplicableSpendSpecifier::SpendType]
            #   @param discounted [Symbol, MetronomeSDK::Models::V1::PackageListResponse::SpendTracker::ApplicableSpendSpecifier::Discounted]
            ...
            # @see MetronomeSDK::Models::V1::PackageListResponse::SpendTracker::ApplicableSpendSpecifier#spend_type
            module SpendType
              extend MetronomeSDK::Internal::Type::Enum
            ...
            # @see MetronomeSDK::Models::V1::PackageListResponse::SpendTracker::ApplicableSpendSpecifier#discounted
            module Discounted
              extend MetronomeSDK::Internal::Type::Enum
          ...
          # @see MetronomeSDK::Models::V1::PackageListResponse::SpendTracker#reset_frequency
