  ...
  module Models
    module V1
      ...
      class CustomerListBillableMetricsResponse < MetronomeSDK::Internal::Type::BaseModel
        ...
        #
        #   @return [MetronomeSDK::Models::V1::CustomerListBillableMetricsResponse::EventTypeFilter, nil]
        optional :event_type_filter,
                 -> { MetronomeSDK::Models::V1::CustomerListBillableMetricsResponse::EventTypeFilter }
        ...
        #   billable metric.
        #
        #   @return [Array<MetronomeSDK::Models::V1::CustomerListBillableMetricsResponse::PropertyFilter>, nil]
        optional :property_filters,
                 -> { MetronomeSDK::Internal::Type::ArrayOf[MetronomeSDK::Models::V1::CustomerListBillableMetricsResponse::PropertyFilter] }
        ...
        #
        #   @param event_type_filter [MetronomeSDK::Models::V1::CustomerListBillableMetricsResponse::EventTypeFilter] An optional filtering rule to match the 'event_type' property of an event.
        #
        ...
        #
        #   @param property_filters [Array<MetronomeSDK::Models::V1::CustomerListBillableMetricsResponse::PropertyFilter>] A list of filters to match events to this billable metric. Each filter defines a
        #
        ...
        # @see MetronomeSDK::Models::V1::CustomerListBillableMetricsResponse#event_type_filter
        ...
        class PropertyFilter < MetronomeSDK::Internal::Type::BaseModel
          ...
          #   Some parameter documentations has been truncated, see
          #   {MetronomeSDK::Models::V1::CustomerListBillableMetricsResponse::PropertyFilter}
          #   for more details.
          #
