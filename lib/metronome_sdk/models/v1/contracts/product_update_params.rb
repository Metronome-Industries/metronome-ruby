    ...
    module V1
      module Contracts
        ...
        class ProductUpdateParams < MetronomeSDK::Internal::Type::BaseModel
          ...
          #   "divide".
          #
          #   @return [MetronomeSDK::V1::Contracts::ProductUpdateParams::QuantityConversion, nil]
          ...
          #
          #   @return [MetronomeSDK::V1::Contracts::ProductUpdateParams::QuantityRounding, nil]
          ...
          #
          #   @param quantity_conversion [MetronomeSDK::V1::Contracts::ProductUpdateParams::QuantityConversion, nil] Optional. Only valid for USAGE products. If provided, the quantity will be conve
          #
          #   @param quantity_rounding [MetronomeSDK::V1::Contracts::ProductUpdateParams::QuantityRounding, nil] Optional. Only valid for USAGE products. If provided, the quantity will be round
          #
          ...
          class QuantityConversion < MetronomeSDK::Internal::Type::BaseModel
            ...
            #
            #   @return [Symbol, MetronomeSDK::V1::Contracts::ProductUpdateParams::QuantityConversion::Operation]
            required :operation,
                     enum: -> {
            ...
            #
            #   @param operation [Symbol, MetronomeSDK::V1::Contracts::ProductUpdateParams::QuantityConversion::Operation] The operation to perform on the quantity
            #
            #   @param name [String] Optional name for this conversion.

            # The operation to perform on the quantity
            #
            # @see MetronomeSDK::V1::Contracts::ProductUpdateParams::QuantityConversion#operation
            module Operation
          ...
          class QuantityRounding < MetronomeSDK::Internal::Type::BaseModel
            ...
            #
            #   @return [Symbol, MetronomeSDK::V1::Contracts::ProductUpdateParams::QuantityRounding::RoundingMethod]
            ...
            #   @param rounding_method [Symbol, MetronomeSDK::V1::Contracts::ProductUpdateParams::QuantityRounding::RoundingMethod]

            # @see MetronomeSDK::V1::Contracts::ProductUpdateParams::QuantityRounding#rounding_method
