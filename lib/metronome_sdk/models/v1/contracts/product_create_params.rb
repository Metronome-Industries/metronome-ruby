    ...
    module V1
      module Contracts
        ...
        class ProductCreateParams < MetronomeSDK::Internal::Type::BaseModel
          ...
          # @!attribute type
          #
          #   @return [Symbol, MetronomeSDK::V1::Contracts::ProductCreateParams::Type]
          ...
          #   "divide".
          #
          #   @return [MetronomeSDK::V1::Contracts::ProductCreateParams::QuantityConversion, nil]
          optional :quantity_conversion,
                   -> { MetronomeSDK::V1::Contracts::ProductCreateParams::QuantityConversion },
                   nil?: true
          ...
          #
          #   @return [MetronomeSDK::V1::Contracts::ProductCreateParams::QuantityRounding, nil]
          optional :quantity_rounding,
                   -> { MetronomeSDK::V1::Contracts::ProductCreateParams::QuantityRounding },
                   nil?: true
          ...
          #
          #   @param quantity_conversion [MetronomeSDK::V1::Contracts::ProductCreateParams::QuantityConversion, nil] Optional. Only valid for USAGE products. If provided, the quantity will be conve
          #
          #   @param quantity_rounding [MetronomeSDK::V1::Contracts::ProductCreateParams::QuantityRounding, nil] Optional. Only valid for USAGE products. If provided, the quantity will be round
          #
          ...
          class QuantityConversion < MetronomeSDK::Internal::Type::BaseModel
            ...
            #
            #   @return [Symbol, MetronomeSDK::V1::Contracts::ProductCreateParams::QuantityConversion::Operation]
            required :operation,
                     enum: -> {
                       MetronomeSDK::V1::Contracts::ProductCreateParams::QuantityConversion::Operation
                     }
            ...
            #
            #   @param operation [Symbol, MetronomeSDK::V1::Contracts::ProductCreateParams::QuantityConversion::Operation] The operation to perform on the quantity
            #
            #   @param name [String] Optional name for this conversion.

            # The operation to perform on the quantity
            #
            # @see MetronomeSDK::V1::Contracts::ProductCreateParams::QuantityConversion#operation
            module Operation
              extend MetronomeSDK::Internal::Type::Enum
          ...
          class QuantityRounding < MetronomeSDK::Internal::Type::BaseModel
            ...
            #
            #   @return [Symbol, MetronomeSDK::V1::Contracts::ProductCreateParams::QuantityRounding::RoundingMethod]
            required :rounding_method,
                     enum: -> {
                       MetronomeSDK::V1::Contracts::ProductCreateParams::QuantityRounding::RoundingMethod
                     }
            ...
            #   @param rounding_method [Symbol, MetronomeSDK::V1::Contracts::ProductCreateParams::QuantityRounding::RoundingMethod]

            # @see MetronomeSDK::V1::Contracts::ProductCreateParams::QuantityRounding#rounding_method
