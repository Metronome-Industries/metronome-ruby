    ...
    module V1
      module Contracts
        ...
        class ProductCreateParams < MetronomeSDK::Internal::Type::BaseModel
          ...
          #   "divide".
          #
          #   @return [MetronomeSDK::Models::V1::Contracts::ProductCreateParams::QuantityConversion, nil]
          ...
          #
          #   @return [MetronomeSDK::Models::V1::Contracts::ProductCreateParams::QuantityRounding, nil]
          ...
          class QuantityConversion < MetronomeSDK::Internal::Type::BaseModel
            ...
            #
            #   @return [Symbol, MetronomeSDK::Models::V1::Contracts::ProductCreateParams::QuantityConversion::Operation]
            required :operation,
                     enum: -> { MetronomeSDK::V1::Contracts::ProductCreateParams::QuantityConversion::Operation }
            ...
            #
            #   @param operation [Symbol, MetronomeSDK::Models::V1::Contracts::ProductCreateParams::QuantityConversion::Operation] The operation to perform on the quantity
            #
            #   @param name [String] Optional name for this conversion.

            # The operation to perform on the quantity
            #
            # @see MetronomeSDK::Models::V1::Contracts::ProductCreateParams::QuantityConversion#operation
            module Operation
              extend MetronomeSDK::Internal::Type::Enum
          ...
          class QuantityRounding < MetronomeSDK::Internal::Type::BaseModel
            ...
            #
            #   @return [Symbol, MetronomeSDK::Models::V1::Contracts::ProductCreateParams::QuantityRounding::RoundingMethod]
            required :rounding_method,
                     enum: -> { MetronomeSDK::V1::Contracts::ProductCreateParams::QuantityRounding::RoundingMethod }
            ...
            #   @param rounding_method [Symbol, MetronomeSDK::Models::V1::Contracts::ProductCreateParams::QuantityRounding::RoundingMethod]

            # @see MetronomeSDK::Models::V1::Contracts::ProductCreateParams::QuantityRounding#rounding_method
