  ...
  module Models
    module V1
      ...
      class CustomerCreateResponse < MetronomeSDK::Internal::Type::BaseModel
        # @!attribute data
        #
        #   @return [MetronomeSDK::Models::V1::CustomerCreateResponse::Data]
        required :data, -> { MetronomeSDK::Models::V1::CustomerCreateResponse::Data }

        # @!method initialize(data:)
        #   @param data [MetronomeSDK::Models::V1::CustomerCreateResponse::Data]

        # @see MetronomeSDK::Models::V1::CustomerCreateResponse#data
        class Data < MetronomeSDK::Internal::Type::BaseModel
          ...
          #   {MetronomeSDK::Models::V1::CustomerCreateResponse::Data} for more details.
          #
