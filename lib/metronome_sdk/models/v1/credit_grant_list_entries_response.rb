    ...
    module V1
      ...
      class CreditGrantListEntriesResponse < MetronomeSDK::Internal::Type::BaseModel
        ...
        class Ledger < MetronomeSDK::Internal::Type::BaseModel
          ...
          #
          #   @return [MetronomeSDK::Models::V1::CreditGrantListEntriesResponse::Ledger::CreditType]
          required :credit_type, -> { MetronomeSDK::Models::V1::CreditGrantListEntriesResponse::Ledger::CreditType }
          ...
          # @!attribute entries
          #
          #   @return [Array<MetronomeSDK::Models::V1::CreditGrantListEntriesResponse::Ledger::Entry>]
          required :entries,
                   -> { MetronomeSDK::Internal::Type::ArrayOf[MetronomeSDK::Models::V1::CreditGrantListEntriesResponse::Ledger::Entry] }

          # @!attribute pending_entries
          #
          #   @return [Array<MetronomeSDK::Models::V1::CreditGrantListEntriesResponse::Ledger::PendingEntry>]
          required :pending_entries,
                   -> { MetronomeSDK::Internal::Type::ArrayOf[MetronomeSDK::Models::V1::CreditGrantListEntriesResponse::Ledger::PendingEntry] }
          ...
          #   @param credit_type [MetronomeSDK::Models::V1::CreditGrantListEntriesResponse::Ledger::CreditType]
          #
          ...
          #
          #   @param entries [Array<MetronomeSDK::Models::V1::CreditGrantListEntriesResponse::Ledger::Entry>]
          #
          #   @param pending_entries [Array<MetronomeSDK::Models::V1::CreditGrantListEntriesResponse::Ledger::PendingEntry>]
          #
          #   @param starting_balance [MetronomeSDK::Models::V1::CreditGrantListEntriesResponse::Ledger::StartingBalance]

          # @see MetronomeSDK::Models::V1::CreditGrantListEntriesResponse::Ledger#credit_type
          ...
          class Entry < MetronomeSDK::Internal::Type::BaseModel
            ...
            #   Some parameter documentations has been truncated, see
            #   {MetronomeSDK::Models::V1::CreditGrantListEntriesResponse::Ledger::Entry} for
            #   more details.
            #
