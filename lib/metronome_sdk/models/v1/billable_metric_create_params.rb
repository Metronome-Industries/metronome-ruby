  ...
  module Models
    module V1
      ...
      class BillableMetricCreateParams < MetronomeSDK::Internal::Type::BaseModel
        ...
        #
        #   @return [MetronomeSDK::V1::BillableMetricCreateParams::EventTypeFilter, nil]
        ...
        #   billable metric.
        #
        #   @return [Array<MetronomeSDK::V1::BillableMetricCreateParams::PropertyFilter>, nil]
        ...
        #
        #   @param event_type_filter [MetronomeSDK::V1::BillableMetricCreateParams::EventTypeFilter] An optional filtering rule to match the 'event_type' property of an event.
        #
        #   @param group_keys [Array<Array<String>>] Property names that are used to group usage costs on an invoice. Each entry repr
        #
        #   @param property_filters [Array<MetronomeSDK::V1::BillableMetricCreateParams::PropertyFilter>] A list of filters to match events to this billable metric. Each filter defines a
        #
        ...
        class EventTypeFilter < MetronomeSDK::Internal::Type::BaseModel
          ...
          #   Some parameter documentations has been truncated, see
          #   {MetronomeSDK::V1::BillableMetricCreateParams::EventTypeFilter} for more
          #   details.
          #
          #   An optional filtering rule to match the 'event_type' property of an event.
          #
        ...
        class PropertyFilter < MetronomeSDK::Internal::Type::BaseModel
          ...
          #   Some parameter documentations has been truncated, see
          #   {MetronomeSDK::V1::BillableMetricCreateParams::PropertyFilter} for more details.
          #
