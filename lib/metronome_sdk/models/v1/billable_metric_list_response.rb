  ...
  module Models
    module V1
      ...
      class BillableMetricListResponse < MetronomeSDK::Internal::Type::BaseModel
        ...
        #
        #   @return [Symbol, MetronomeSDK::Models::V1::BillableMetricListResponse::AggregationType, nil]
        ...
        #
        #   @return [MetronomeSDK::Models::V1::BillableMetricListResponse::EventTypeFilter, nil]
        optional :event_type_filter, -> { MetronomeSDK::Models::V1::BillableMetricListResponse::EventTypeFilter }
        ...
        #   billable metric.
        #
        #   @return [Array<MetronomeSDK::Models::V1::BillableMetricListResponse::PropertyFilter>, nil]
        optional :property_filters,
                 -> { MetronomeSDK::Internal::Type::ArrayOf[MetronomeSDK::Models::V1::BillableMetricListResponse::PropertyFilter] }
        ...
        #   {MetronomeSDK::Models::V1::BillableMetricListResponse} for more details.
        #
        ...
        #
        #   @param aggregation_type [Symbol, MetronomeSDK::Models::V1::BillableMetricListResponse::AggregationType] Specifies the type of aggregation performed on matching events.
        #
        #   @param archived_at [Time] RFC 3339 timestamp indicating when the billable metric was archived. If not prov
        #
        #   @param custom_fields [Hash{Symbol=>String}]
        #
        #   @param event_type_filter [MetronomeSDK::Models::V1::BillableMetricListResponse::EventTypeFilter] An optional filtering rule to match the 'event_type' property of an event.
        #
        #   @param group_keys [Array<Array<String>>] Property names that are used to group usage costs on an invoice. Each entry repr
        #
        #   @param property_filters [Array<MetronomeSDK::Models::V1::BillableMetricListResponse::PropertyFilter>] A list of filters to match events to this billable metric. Each filter defines a
        #
        #   @param sql [String] The SQL query associated with the billable metric

        # Specifies the type of aggregation performed on matching events.
        #
        # @see MetronomeSDK::Models::V1::BillableMetricListResponse#aggregation_type
        ...
        # @see MetronomeSDK::Models::V1::BillableMetricListResponse#event_type_filter
        class EventTypeFilter < MetronomeSDK::Internal::Type::BaseModel
          ...
          #   Some parameter documentations has been truncated, see
          #   {MetronomeSDK::Models::V1::BillableMetricListResponse::EventTypeFilter} for more
          #   details.
          #
          #   An optional filtering rule to match the 'event_type' property of an event.
          #
        ...
        class PropertyFilter < MetronomeSDK::Internal::Type::BaseModel
          ...
          #   Some parameter documentations has been truncated, see
          #   {MetronomeSDK::Models::V1::BillableMetricListResponse::PropertyFilter} for more
          #   details.
          #
