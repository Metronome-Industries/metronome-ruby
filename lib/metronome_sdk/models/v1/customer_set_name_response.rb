  ...
  module Models
    module V1
      ...
      class CustomerSetNameResponse < MetronomeSDK::Internal::Type::BaseModel
        # @!attribute data
        #
        #   @return [MetronomeSDK::Models::V1::CustomerSetNameResponse::Data]
        required :data, -> { MetronomeSDK::Models::V1::CustomerSetNameResponse::Data }

        # @!method initialize(data:)
        #   @param data [MetronomeSDK::Models::V1::CustomerSetNameResponse::Data]

        # @see MetronomeSDK::Models::V1::CustomerSetNameResponse#data
        class Data < MetronomeSDK::Internal::Type::BaseModel
          ...
          #   {MetronomeSDK::Models::V1::CustomerSetNameResponse::Data} for more details.
          #
