    ...
    module V1
      ...
      class CustomerSetBillingConfigurationsParams < MetronomeSDK::Internal::Type::BaseModel
        ...
        class Data < MetronomeSDK::Internal::Type::BaseModel
          ...
          #
          #   @return [Array<MetronomeSDK::Models::V1::CustomerSetBillingConfigurationsParams::Data::UnbillableInvoicesConfiguration>, nil]
          optional :unbillable_invoices_configuration,
                   -> { MetronomeSDK::Internal::Type::ArrayOf[MetronomeSDK::V1::CustomerSetBillingConfigurationsParams::Data::UnbillableInvoicesConfiguration] }

          # @!method initialize(billing_provider:, customer_id:, configuration: nil, delivery_method: nil, delivery_method_id: nil, tax_provider: nil, unbillable_invoices_configuration: nil)
          ...
          #
          #   @param unbillable_invoices_configuration [Array<MetronomeSDK::Models::V1::CustomerSetBillingConfigurationsParams::Data::UnbillableInvoicesConfiguration>] Rules that stop matching invoices from being sent to the billing provider. Only
          ...
          class UnbillableInvoicesConfiguration < MetronomeSDK::Internal::Type::BaseModel
            ...
            #
            #   @return [Symbol, MetronomeSDK::Models::V1::CustomerSetBillingConfigurationsParams::Data::UnbillableInvoicesConfiguration::InvoiceType]
            required :invoice_type,
                     enum: -> { MetronomeSDK::V1::CustomerSetBillingConfigurationsParams::Data::UnbillableInvoicesConfiguration::InvoiceType }
            ...
            #   Some parameter documentations has been truncated, see
            #   {MetronomeSDK::Models::V1::CustomerSetBillingConfigurationsParams::Data::UnbillableInvoicesConfiguration}
            #   for more details.
            #
            ...
            #
            #   @param invoice_type [Symbol, MetronomeSDK::Models::V1::CustomerSetBillingConfigurationsParams::Data::UnbillableInvoicesConfiguration::InvoiceType] The type of invoice this rule applies to.
            #
            ...
            # The type of invoice this rule applies to.
            #
            # @see MetronomeSDK::Models::V1::CustomerSetBillingConfigurationsParams::Data::UnbillableInvoicesConfiguration#invoice_type
            module InvoiceType
              extend MetronomeSDK::Internal::Type::Enum
