...
module MetronomeSDK
  module Models
    ...
    class NotificationArchiveResponse < MetronomeSDK::Internal::Type::BaseModel
      # @!attribute data
      #
      #   @return [MetronomeSDK::Models::NotificationArchiveResponse::Data]
      required :data, -> { MetronomeSDK::Models::NotificationArchiveResponse::Data }

      # @!method initialize(data:)
      #   @param data [MetronomeSDK::Models::NotificationArchiveResponse::Data]

      # @see MetronomeSDK::Models::NotificationArchiveResponse#data
      class Data < MetronomeSDK::Internal::Type::BaseModel
        ...
        # @!attribute policy
        #
        #   @return [MetronomeSDK::Models::NotificationArchiveResponse::Data::Policy]
        required :policy, -> { MetronomeSDK::Models::NotificationArchiveResponse::Data::Policy }
        ...
        #   {MetronomeSDK::Models::NotificationArchiveResponse::Data} for more details.
        #
        ...
        #
        #   @param policy [MetronomeSDK::Models::NotificationArchiveResponse::Data::Policy]
        #
        #   @param type [String] Indicates this is an offset lifecycle event notification

        # @see MetronomeSDK::Models::NotificationArchiveResponse::Data#policy
        class Policy < MetronomeSDK::Internal::Type::BaseModel
          ...
          #   Some parameter documentations has been truncated, see
          #   {MetronomeSDK::Models::NotificationArchiveResponse::Data::Policy} for more
          #   details.
          #
