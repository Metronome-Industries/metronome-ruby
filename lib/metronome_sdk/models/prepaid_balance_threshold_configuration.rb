  ...
  module Models
    class PrepaidBalanceThresholdConfiguration < MetronomeSDK::Internal::Type::BaseModel
      ...
      class Commit < MetronomeSDK::Models::BaseThresholdCommit
        ...
        #
        #   @return [MetronomeSDK::Models::PrepaidBalanceThresholdConfiguration::Commit::Duration, nil]
        optional :duration, -> { MetronomeSDK::PrepaidBalanceThresholdConfiguration::Commit::Duration }

        # @!attribute rate_type
        #   Whether the created commits will be charged at commit rate or list rate.
        #
        #   @return [Symbol, MetronomeSDK::Models::PrepaidBalanceThresholdConfiguration::Commit::RateType, nil]
        optional :rate_type, enum: -> { MetronomeSDK::PrepaidBalanceThresholdConfiguration::Commit::RateType }
        ...
        #
        #   @param duration [MetronomeSDK::Models::PrepaidBalanceThresholdConfiguration::Commit::Duration] The length of time the created commit will be valid, starting from the end of th
        #
        #   @param rate_type [Symbol, MetronomeSDK::Models::PrepaidBalanceThresholdConfiguration::Commit::RateType] Whether the created commits will be charged at commit rate or list rate.
        #
        ...
        class Duration < MetronomeSDK::Internal::Type::BaseModel
          # @!attribute unit
          #
          #   @return [Symbol, MetronomeSDK::Models::PrepaidBalanceThresholdConfiguration::Commit::Duration::Unit]
          required :unit, enum: -> { MetronomeSDK::PrepaidBalanceThresholdConfiguration::Commit::Duration::Unit }
          ...
          #   the invoice's service period. If not provided, defaults to one year.
          #
          #   @param unit [Symbol, MetronomeSDK::Models::PrepaidBalanceThresholdConfiguration::Commit::Duration::Unit]
          #   @param value [Integer]

          # @see MetronomeSDK::Models::PrepaidBalanceThresholdConfiguration::Commit::Duration#unit
          module Unit
