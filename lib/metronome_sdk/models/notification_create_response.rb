...
module MetronomeSDK
  module Models
    ...
    class NotificationCreateResponse < MetronomeSDK::Internal::Type::BaseModel
      # @!attribute data
      #
      #   @return [MetronomeSDK::Models::NotificationCreateResponse::Data]
      required :data, -> { MetronomeSDK::Models::NotificationCreateResponse::Data }

      # @!method initialize(data:)
      #   @param data [MetronomeSDK::Models::NotificationCreateResponse::Data]

      # @see MetronomeSDK::Models::NotificationCreateResponse#data
      class Data < MetronomeSDK::Internal::Type::BaseModel
        ...
        # @!attribute policy
        #
        #   @return [MetronomeSDK::Models::NotificationCreateResponse::Data::Policy]
        required :policy, -> { MetronomeSDK::Models::NotificationCreateResponse::Data::Policy }
        ...
        #   {MetronomeSDK::Models::NotificationCreateResponse::Data} for more details.
        #
        ...
        #
        #   @param policy [MetronomeSDK::Models::NotificationCreateResponse::Data::Policy]
        #
        #   @param type [String] Indicates this is an offset lifecycle event notification

        # @see MetronomeSDK::Models::NotificationCreateResponse::Data#policy
        class Policy < MetronomeSDK::Internal::Type::BaseModel
          ...
          #   Some parameter documentations has been truncated, see
          #   {MetronomeSDK::Models::NotificationCreateResponse::Data::Policy} for more
          #   details.
          #
