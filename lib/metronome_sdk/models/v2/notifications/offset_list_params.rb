  ...
  module Models
    module V2
      module Notifications
        # @see MetronomeSDK::Resources::V2::Notifications::Offset#list
        class OffsetListParams < MetronomeSDK::Internal::Type::BaseModel
          ...
          #   NOT_ARCHIVED.
          #
          #   @return [Symbol, MetronomeSDK::Models::V2::Notifications::OffsetListParams::ArchiveFilter, nil]
          optional :archive_filter, enum: -> { MetronomeSDK::V2::Notifications::OffsetListParams::ArchiveFilter }
