  ...
  module Models
    module V2
      module Notifications
        ...
        class OffsetEditParams < MetronomeSDK::Internal::Type::BaseModel
          ...
          #   event type.
          #
          #   @return [MetronomeSDK::Models::V2::Notifications::OffsetEditParams::Policy::LifecycleEventOffsetPolicy, MetronomeSDK::Models::V2::Notifications::OffsetEditParams::Policy::LifecycleEventSystemPolicy]
          required :policy, union: -> { MetronomeSDK::V2::Notifications::OffsetEditParams::Policy }
          ...
          module Policy
            ...
            variant -> { MetronomeSDK::V2::Notifications::OffsetEditParams::Policy::LifecycleEventOffsetPolicy }

            variant -> { MetronomeSDK::V2::Notifications::OffsetEditParams::Policy::LifecycleEventSystemPolicy }
            ...
            class LifecycleEventOffsetPolicy < MetronomeSDK::Internal::Type::BaseModel
              ...
              #   Some parameter documentations has been truncated, see
              #   {MetronomeSDK::Models::V2::Notifications::OffsetEditParams::Policy::LifecycleEventOffsetPolicy}
              #   for more details.
              #
            ...
            #   @return [Array(MetronomeSDK::Models::V2::Notifications::OffsetEditParams::Policy::LifecycleEventOffsetPolicy, MetronomeSDK::Models::V2::Notifications::OffsetEditParams::Policy::LifecycleEventSystemPolicy)]
          end
        end
      end
    end
