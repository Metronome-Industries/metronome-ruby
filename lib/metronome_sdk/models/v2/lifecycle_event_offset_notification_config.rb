  ...
  module Models
    module V2
      class LifecycleEventOffsetNotificationConfig < MetronomeSDK::Internal::Type::BaseModel
        ...
        # @!attribute policy
        #
        #   @return [MetronomeSDK::Models::V2::LifecycleEventOffsetNotificationConfig::Policy]
        required :policy, -> { MetronomeSDK::V2::LifecycleEventOffsetNotificationConfig::Policy }
        ...
        #
        #   @param policy [MetronomeSDK::Models::V2::LifecycleEventOffsetNotificationConfig::Policy]
        #
        #   @param type [String] Indicates this is an offset lifecycle event notification

        # @see MetronomeSDK::Models::V2::LifecycleEventOffsetNotificationConfig#policy
        class Policy < MetronomeSDK::Internal::Type::BaseModel
          ...
          #   Some parameter documentations has been truncated, see
          #   {MetronomeSDK::Models::V2::LifecycleEventOffsetNotificationConfig::Policy} for
          #   more details.
          #
