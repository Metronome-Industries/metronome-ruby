...
module MetronomeSDK
  ...
  module Converter
    ...
    class << self
      # @private
      #
      # @param spec [Hash{Symbol=>Object}, Proc, MetronomeSDK::Converter, Class] .
      #
      ...
      def type_info(spec)
        ...
        in Proc
          spec
        in MetronomeSDK::Converter | Class
          -> { spec }
        in true | false
          -> { MetronomeSDK::BooleanModel }
      ...
      #
      # @param target [MetronomeSDK::Converter, Class]
      # @param value [Object]
      #
      # @return [Object]
      #
  ...
  class Unknown
    ...
    # @return [Boolean]
    #
    def self.==(other) = other.is_a?(Class) && other <= MetronomeSDK::Unknown
  ...
  class BooleanModel
    ...
    # @return [Boolean]
    #
    def self.==(other) = other.is_a?(Class) && other <= MetronomeSDK::BooleanModel
  ...
  class Enum
    ...
    #
    def self.==(other)
      other.is_a?(Class) && other <= MetronomeSDK::Enum && other.values.to_set == values.to_set
    end
  ...
  class Union
    ...
    # @private
    #
    # @param key [Symbol, Hash{Symbol=>Object}, Proc, MetronomeSDK::Converter, Class]
    #
    # @param spec [Hash{Symbol=>Object}, Proc, MetronomeSDK::Converter, Class] .
    #
    #   @option spec [NilClass, TrueClass, FalseClass, Integer, Float, Symbol] :const
    ...
    private_class_method def self.variant(key, spec = nil)
      variant_info =
        case key
        in Symbol
          [key, MetronomeSDK::Converter.type_info(spec)]
        in Proc | MetronomeSDK::Converter | Class | Hash
          [nil, MetronomeSDK::Converter.type_info(key)]
        end
    ...
    # @param value [Object]
    #
    # @return [MetronomeSDK::Converter, Class, nil]
    #
    private_class_method def self.resolve_variant(value)
      case [@discriminator, value]
      in [_, MetronomeSDK::BaseModel]
        value.class
      in [Symbol, Hash]
        key =
        ...
        resolved.nil? ? MetronomeSDK::Unknown : resolved.call
      else
        nil
      end
    end
    ...
    #
    def self.==(other)
      other.is_a?(Class) && other <= MetronomeSDK::Union && other.variants == variants
    end
    ...
    def self.coerce(value)
      if (variant = resolve_variant(value))
        return MetronomeSDK::Converter.coerce(variant, value)
      end
      ...
      known_variants.each do |_, variant_fn|
        ...
        case MetronomeSDK::Converter.try_strict_coerce(variant, value)
        in [true, coerced, _]
          return coerced
        in [false, true, score]
      ...
      variant.nil? ? value : MetronomeSDK::Converter.coerce(variant, value)
    end
    ...
    def self.dump(value)
      if (variant = resolve_variant(value))
        return MetronomeSDK::Converter.dump(variant, value)
      end
  ...
  class ArrayOf
    include MetronomeSDK::Converter
    ...
    # @return [Boolean]
    #
    def ==(other) = other.is_a?(MetronomeSDK::ArrayOf) && other.item_type == item_type
    ...
    def coerce(value)
      ...
      in Enumerable unless value.is_a?(Hash)
        value.map { MetronomeSDK::Converter.coerce(type, _1) }
      else
        value
      end
    end
    ...
    def dump(value)
      ...
      case value
      in Enumerable unless value.is_a?(Hash)
        value.map { MetronomeSDK::Converter.dump(type, _1) }.to_a
      else
        value
      end
    end
    ...
    def try_strict_coerce(value)
      ...
      in Array
        ...
        mapped =
          value.map do |item|
            case MetronomeSDK::Converter.try_strict_coerce(type, item)
            in [true, coerced, score]
              tally += score
              coerced
            in [false, true, score]
    ...
    # @private
    #
    # @return [MetronomeSDK::Converter, Class]
    #
    protected def item_type = @item_type_fn.call

    # @private
    #
    # @param type_info [Hash{Symbol=>Object}, Proc, MetronomeSDK::Converter, Class]
    #
    ...
    def initialize(type_info, spec = {})
      @item_type_fn = MetronomeSDK::Converter.type_info(type_info || spec)
    end
  end
  ...
  class HashOf
    ...
    # @return [Boolean]
    #
    def ==(other) = other.is_a?(MetronomeSDK::HashOf) && other.item_type == item_type
    ...
    def coerce(value)
      ...
      in Hash
        value.to_h do |key, val|
          coerced = MetronomeSDK::Converter.coerce(type, val)
    ...
    def dump(value)
      ...
      in Hash
        value.transform_values do |val|
          MetronomeSDK::Converter.dump(type, val)
        end
      else
        value
      end
    ...
    def try_strict_coerce(value)
      ...
      in Hash
        ...
        mapped =
          value.transform_values do |val|
            case MetronomeSDK::Converter.try_strict_coerce(type, val)
            in [true, coerced, score]
              tally += score
              coerced
            in [false, true, score]
  ...
  class BaseModel
    ...
    def self.known_fields
      @known_fields ||= (self < MetronomeSDK::BaseModel ? superclass.known_fields.dup : {})
    end
    ...
    private_class_method def self.add_field(name_sym, required:, type_info:, spec:)
      type_fn, info =
        case type_info
        in Proc | Class | MetronomeSDK::Converter
          [MetronomeSDK::Converter.type_info({**spec, union: type_info}), spec]
        in Hash
          [MetronomeSDK::Converter.type_info(type_info), type_info]
        end
      ...
      define_method(name_sym) do
        ...
        MetronomeSDK::Converter.coerce(field_type, value)
      rescue StandardError
        name = self.class.name.split("::").last
        raise MetronomeSDK::ConversionError.new(
    ...
    # @private
    #
    # @param value [MetronomeSDK::BaseModel, Hash{Object=>Object}, Object]
    #
    # @return [MetronomeSDK::BaseModel, Object]
    #
    def self.coerce(value)
      case MetronomeSDK::Util.coerce_hash(value)
      in Hash => coerced
        new(coerced)
      else
        value
    ...
    # @private
    #
    # @param value [MetronomeSDK::BaseModel, Object]
    #
    # @return [Hash{Object=>Object}, Object]
    #
    def self.dump(value)
      unless (coerced = MetronomeSDK::Util.coerce_hash(value)).is_a?(Hash)
        return value
      end
      ...
      values = coerced.filter_map do |key, val|
        ...
        in nil
          ...
          in :coerce
            ...
            target = type_fn.call
            [api_name, MetronomeSDK::Converter.dump(target, val)]
          end
        end
      end.to_h
    ...
    def self.try_strict_coerce(value)
      case value
      in Hash | MetronomeSDK::BaseModel
        value = value.to_h
      else
      ...
      known_fields.each_value do |field|
        ...
        in [_, true]
          ...
          case MetronomeSDK::Converter.try_strict_coerce(target, item)
          in [true, coerced, score]
            tally += score
    ...
    #
    # @param data [Hash{Symbol=>Object}, MetronomeSDK::BaseModel]
    #
    def initialize(data = {})
      case MetronomeSDK::Util.coerce_hash(data)
      in Hash => coerced
        @data = coerced.transform_keys(&:to_sym)
      else
        raise ArgumentError.new("Expected a #{Hash} or #{MetronomeSDK::BaseModel}, got #{data.inspect}")
      end
    end
