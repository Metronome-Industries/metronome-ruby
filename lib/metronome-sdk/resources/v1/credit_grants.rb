  ...
  module Resources
    class V1
      class CreditGrants
        ...
        #
        # @param params [MetronomeSDK::Models::V1::CreditGrantCreateParams, Hash{Symbol=>Object}] .
        #
        ...
        #
        #   @option params [MetronomeSDK::Models::V1::CreditGrantCreateParams::GrantAmount] :grant_amount the amount of credits granted
        #
        #   @option params [String] :name the name of the credit grant as it will appear on invoices
        #
        #   @option params [MetronomeSDK::Models::V1::CreditGrantCreateParams::PaidAmount] :paid_amount the amount paid for this credit grant
        #
        ...
        #
        #   @option params [MetronomeSDK::Models::V1::CreditGrantCreateParams::RolloverSettings] :rollover_settings Configure a rollover for this credit grant so if it expires it rolls over a
        ...
        #
        # @param params [MetronomeSDK::Models::V1::CreditGrantListParams, Hash{Symbol=>Object}] .
        #
        ...
        #   @option params [MetronomeSDK::RequestOptions, Hash{Symbol=>Object}, nil] :request_options
        #
        # @return [MetronomeSDK::CursorPage<MetronomeSDK::Models::V1::CreditGrantListResponse>]
        #
        def list(params = {})
        ...
        #
        # @param params [MetronomeSDK::Models::V1::CreditGrantEditParams, Hash{Symbol=>Object}] .
        #
        ...
        #
        # @param params [MetronomeSDK::Models::V1::CreditGrantListEntriesParams, Hash{Symbol=>Object}] .
        #
        #   @option params [String] :next_page Query param: Cursor that indicates where the next page of results should start.
        #
        ...
        # Void a credit grant
        #
        # @param params [MetronomeSDK::Models::V1::CreditGrantVoidParams, Hash{Symbol=>Object}] .
        #
