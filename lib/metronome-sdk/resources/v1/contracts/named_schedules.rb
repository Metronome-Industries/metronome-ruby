    ...
    class V1
      class Contracts
        class NamedSchedules
          ...
          #
          # @param params [MetronomeSDK::Models::V1::Contracts::NamedScheduleRetrieveParams, Hash{Symbol=>Object}] .
          #
          ...
          #
          def retrieve(params)
            parsed, options = MetronomeSDK::Models::V1::Contracts::NamedScheduleRetrieveParams.dump_request(params)
            @client.request(
              method: :post,
          ...
          #   dependent on your client's configuration.
          #
          # @param params [MetronomeSDK::Models::V1::Contracts::NamedScheduleUpdateParams, Hash{Symbol=>Object}] .
          #
          ...
          #
          def update(params)
            parsed, options = MetronomeSDK::Models::V1::Contracts::NamedScheduleUpdateParams.dump_request(params)
            @client.request(
              method: :post,
