...
module MetronomeSDK
  module Models
    module V1
      class ContractRetrieveRateScheduleParams < MetronomeSDK::BaseModel
        # @!parse
        ...
        optional :selectors,
                 -> { MetronomeSDK::ArrayOf[MetronomeSDK::Models::V1::ContractRetrieveRateScheduleParams::Selector] }

        # @!parse
        #   # @return [Array<MetronomeSDK::Models::V1::ContractRetrieveRateScheduleParams::Selector>]
        ...
        #   # @param at [Time]
        #   # @param selectors [Array<MetronomeSDK::Models::V1::ContractRetrieveRateScheduleParams::Selector>]
