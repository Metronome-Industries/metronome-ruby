...
module MetronomeSDK
  module Models
    module V1
      module Contracts
        module RateCards
          class RateListParams < MetronomeSDK::BaseModel
            # @!parse
            ...
            optional :selectors,
                     -> { MetronomeSDK::ArrayOf[MetronomeSDK::Models::V1::Contracts::RateCards::RateListParams::Selector] }

            # @!parse
            #   # @return [Array<MetronomeSDK::Models::V1::Contracts::RateCards::RateListParams::Selector>]
            ...
            #   # @param selectors [Array<MetronomeSDK::Models::V1::Contracts::RateCards::RateListParams::Selector>]
