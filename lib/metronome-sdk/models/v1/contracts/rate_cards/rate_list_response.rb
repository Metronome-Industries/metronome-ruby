...
module MetronomeSDK
  module Models
    module V1
      module Contracts
        module RateCards
          class RateListResponse < MetronomeSDK::BaseModel
            # @!attribute entitled
            #
            #   @return [Boolean]
            ...
            # @!parse
            #   # @return [MetronomeSDK::Models::V1::Contracts::RateCards::RateListResponse::CommitRate]
            ...
            #   # @param commit_rate [MetronomeSDK::Models::V1::Contracts::RateCards::RateListResponse::CommitRate]
