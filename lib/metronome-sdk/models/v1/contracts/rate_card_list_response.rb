    ...
    module V1
      module Contracts
        class RateCardListResponse < MetronomeSDK::BaseModel
          ...
          optional :aliases,
                   -> { MetronomeSDK::ArrayOf[MetronomeSDK::Models::V1::Contracts::RateCardListResponse::Alias] }

          # @!parse
          #   # @return [Array<MetronomeSDK::Models::V1::Contracts::RateCardListResponse::Alias>]
          #   attr_writer :aliases
          ...
          optional :credit_type_conversions,
                   -> { MetronomeSDK::ArrayOf[MetronomeSDK::Models::V1::Contracts::RateCardListResponse::CreditTypeConversion] }

          # @!parse
          #   # @return [Array<MetronomeSDK::Models::V1::Contracts::RateCardListResponse::CreditTypeConversion>]
