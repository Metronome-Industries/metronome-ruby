...
module MetronomeSDK
  module Models
    module V1
      module Contracts
        class RateCardRetrieveRateScheduleParams < MetronomeSDK::BaseModel
          # @!parse
          ...
          optional :selectors,
                   -> { MetronomeSDK::ArrayOf[MetronomeSDK::Models::V1::Contracts::RateCardRetrieveRateScheduleParams::Selector] }

          # @!parse
          #   # @return [Array<MetronomeSDK::Models::V1::Contracts::RateCardRetrieveRateScheduleParams::Selector>]
          ...
          #   # @param selectors [Array<MetronomeSDK::Models::V1::Contracts::RateCardRetrieveRateScheduleParams::Selector>]
          ...
          class Selector < MetronomeSDK::BaseModel
            # @!attribute [r] partial_pricing_group_values
            #   List of pricing group key value pairs, rates containing the matching key / value
            #     pairs will be included in the response.
            #
            #   @return [Hash{Symbol=>String}, nil]
            optional :partial_pricing_group_values, MetronomeSDK::HashOf[String]
