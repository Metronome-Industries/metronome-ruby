    ...
    module V1
      module Customers
        class CommitCreateParams < MetronomeSDK::BaseModel
          ...
          # @!parse
          #   # @return [MetronomeSDK::Models::V1::Customers::CommitCreateParams::InvoiceSchedule]
          ...
          # @!parse
          #   # @return [Symbol, MetronomeSDK::Models::V1::Customers::CommitCreateParams::RateType]
          ...
          # @!parse
          #   # @param access_schedule [MetronomeSDK::Models::V1::Customers::CommitCreateParams::AccessSchedule]
          ...
          #   # @param invoice_schedule [MetronomeSDK::Models::V1::Customers::CommitCreateParams::InvoiceSchedule]
          #   # @param name [String]
          ...
          class AccessSchedule < MetronomeSDK::BaseModel
            ...
            required :schedule_items,
                     -> { MetronomeSDK::ArrayOf[MetronomeSDK::Models::V1::Customers::CommitCreateParams::AccessSchedule::ScheduleItem] }
          ...
          class InvoiceSchedule < MetronomeSDK::BaseModel
            ...
            # @!parse
            #   # @return [MetronomeSDK::Models::V1::Customers::CommitCreateParams::InvoiceSchedule::RecurringSchedule]
            ...
            optional :schedule_items,
                     -> { MetronomeSDK::ArrayOf[MetronomeSDK::Models::V1::Customers::CommitCreateParams::InvoiceSchedule::ScheduleItem] }

            # @!parse
            #   # @return [Array<MetronomeSDK::Models::V1::Customers::CommitCreateParams::InvoiceSchedule::ScheduleItem>]
            ...
            #   #
            #   # @param credit_type_id [String]
            #   # @param recurring_schedule [MetronomeSDK::Models::V1::Customers::CommitCreateParams::InvoiceSchedule::RecurringSchedule]
            #   # @param schedule_items [Array<MetronomeSDK::Models::V1::Customers::CommitCreateParams::InvoiceSchedule::ScheduleItem>]
            #   #
