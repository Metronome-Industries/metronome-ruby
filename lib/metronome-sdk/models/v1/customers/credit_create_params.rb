    ...
    module V1
      module Customers
        class CreditCreateParams < MetronomeSDK::BaseModel
          ...
          # @!parse
          #   # @return [Symbol, MetronomeSDK::Models::V1::Customers::CreditCreateParams::RateType]
          ...
          # @!parse
          #   # @param access_schedule [MetronomeSDK::Models::V1::Customers::CreditCreateParams::AccessSchedule]
          ...
          class AccessSchedule < MetronomeSDK::BaseModel
            ...
            required :schedule_items,
                     -> { MetronomeSDK::ArrayOf[MetronomeSDK::Models::V1::Customers::CreditCreateParams::AccessSchedule::ScheduleItem] }
