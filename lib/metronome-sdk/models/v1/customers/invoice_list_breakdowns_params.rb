...
module MetronomeSDK
  module Models
    module V1
      module Customers
        class InvoiceListBreakdownsParams < MetronomeSDK::BaseModel
          # @!parse
          ...
          # @!parse
          #   # @return [Symbol, MetronomeSDK::Models::V1::Customers::InvoiceListBreakdownsParams::Sort]
          #   attr_writer :sort
          ...
          # @!parse
          #   # @return [Symbol, MetronomeSDK::Models::V1::Customers::InvoiceListBreakdownsParams::WindowSize]
          ...
          #   # @param sort [Symbol, MetronomeSDK::Models::V1::Customers::InvoiceListBreakdownsParams::Sort]
          #   # @param status [String]
          #   # @param window_size [Symbol, MetronomeSDK::Models::V1::Customers::InvoiceListBreakdownsParams::WindowSize]
