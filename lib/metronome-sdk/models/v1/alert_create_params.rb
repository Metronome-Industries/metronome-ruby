    ...
    module V1
      class AlertCreateParams < MetronomeSDK::BaseModel
        ...
        optional :custom_field_filters,
                 -> { MetronomeSDK::ArrayOf[MetronomeSDK::Models::V1::AlertCreateParams::CustomFieldFilter] }

        # @!parse
        #   # @return [Array<MetronomeSDK::Models::V1::AlertCreateParams::CustomFieldFilter>]
        ...
        #
        #   @return [Boolean, nil]
        optional :evaluate_on_create, MetronomeSDK::BooleanModel
        ...
        # @!parse
        #   # @return [MetronomeSDK::Models::V1::AlertCreateParams::GroupKeyFilter]
        ...
        # @!parse
        #   # @param alert_type [Symbol, MetronomeSDK::Models::V1::AlertCreateParams::AlertType]
        #   # @param name [String]
        #   # @param threshold [Float]
        #   # @param billable_metric_id [String]
        #   # @param credit_grant_type_filters [Array<String>]
        #   # @param credit_type_id [String]
        #   # @param custom_field_filters [Array<MetronomeSDK::Models::V1::AlertCreateParams::CustomFieldFilter>]
        #   # @param customer_id [String]
        #   # @param evaluate_on_create [Boolean]
        #   # @param group_key_filter [MetronomeSDK::Models::V1::AlertCreateParams::GroupKeyFilter]
