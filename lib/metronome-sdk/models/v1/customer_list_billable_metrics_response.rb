...
module MetronomeSDK
  module Models
    module V1
      class CustomerListBillableMetricsResponse < MetronomeSDK::BaseModel
        # @!attribute id
        #
        #   @return [String]
        required :id, String
        ...
        optional :aggregate_keys, MetronomeSDK::ArrayOf[String]
        ...
        # @!parse
        #   # @return [Symbol, MetronomeSDK::Models::V1::CustomerListBillableMetricsResponse::AggregationType]
        ...
        optional :filter, MetronomeSDK::HashOf[MetronomeSDK::Unknown]
        ...
        #
        #   @return [Array<String>, nil]
        optional :group_by, MetronomeSDK::ArrayOf[String]
        ...
        #   # @param aggregation_type [Symbol, MetronomeSDK::Models::V1::CustomerListBillableMetricsResponse::AggregationType]
