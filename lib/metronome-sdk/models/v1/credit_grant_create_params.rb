  ...
  module Models
    module V1
      class CreditGrantCreateParams < MetronomeSDK::BaseModel
        ...
        required :grant_amount, -> { MetronomeSDK::Models::V1::CreditGrantCreateParams::GrantAmount }
        ...
        required :paid_amount, -> { MetronomeSDK::Models::V1::CreditGrantCreateParams::PaidAmount }
        ...
        optional :product_ids, MetronomeSDK::ArrayOf[String]
        ...
        optional :rollover_settings, -> { MetronomeSDK::Models::V1::CreditGrantCreateParams::RolloverSettings }

        # @!parse
        #   # @return [MetronomeSDK::Models::V1::CreditGrantCreateParams::RolloverSettings]
        ...
        #   # @param grant_amount [MetronomeSDK::Models::V1::CreditGrantCreateParams::GrantAmount]
        #   # @param name [String]
        #   # @param paid_amount [MetronomeSDK::Models::V1::CreditGrantCreateParams::PaidAmount]
        ...
        #   # @param reason [String]
        #   # @param rollover_settings [MetronomeSDK::Models::V1::CreditGrantCreateParams::RolloverSettings]
        ...
        class RolloverSettings < MetronomeSDK::BaseModel
          ...
          required :rollover_amount,
                   union: -> { MetronomeSDK::Models::V1::CreditGrantCreateParams::RolloverSettings::RolloverAmount }
          ...
          #   # @param expires_at [Time]
          #   # @param priority [Float]
          #   # @param rollover_amount [MetronomeSDK::Models::V1::RolloverAmountMaxPercentage, MetronomeSDK::Models::V1::RolloverAmountMaxAmount]
          #   #
          ...
          # in MetronomeSDK::Models::V1::RolloverAmountMaxPercentage
          #   # ...
          # in MetronomeSDK::Models::V1::RolloverAmountMaxAmount
          #   # ...
          # end
          # ```
          class RolloverAmount < MetronomeSDK::Union
            variant -> { MetronomeSDK::Models::V1::RolloverAmountMaxPercentage }

            variant -> { MetronomeSDK::Models::V1::RolloverAmountMaxAmount }
          end
        end
      end
    end
