...
module MetronomeSDK
  module Models
    module V1
      class AuditLogListParams < MetronomeSDK::BaseModel
        # @!parse
        ...
        optional :sort, enum: -> { MetronomeSDK::Models::V1::AuditLogListParams::Sort }

        # @!parse
        #   # @return [Symbol, MetronomeSDK::Models::V1::AuditLogListParams::Sort]
        #   attr_writer :sort
        ...
        #   # @param sort [Symbol, MetronomeSDK::Models::V1::AuditLogListParams::Sort]
