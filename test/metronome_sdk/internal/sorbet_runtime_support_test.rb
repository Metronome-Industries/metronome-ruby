...
class MetronomeSDK::Test::SorbetRuntimeSupportTest < Minitest::Test
  ...
  class M < MetronomeSDK::Internal::Type::BaseModel
  ...
  def test_nil_aliases
    ...
    assert_raises(err) { MetronomeSDK::Internal::Type::BaseModel::KnownField }
    assert_raises(err) { MetronomeSDK::Internal::Util::ParsedUri }
    assert_raises(err) { MetronomeSDK::Internal::Util::ServerSentEvent }
    assert_raises(err) { MetronomeSDK::Internal::Transport::BaseClient::RequestComponents }
    assert_raises(err) { MetronomeSDK::Internal::Transport::BaseClient::RequestInput }
    assert_raises(err) { MetronomeSDK::Internal::Transport::PooledNetRequester::Request }
