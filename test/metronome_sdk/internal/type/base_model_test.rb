...
class MetronomeSDK::Test::PrimitiveModelTest < Minitest::Test
  A = MetronomeSDK::Internal::Type::ArrayOf[-> { Integer }]
  H = MetronomeSDK::Internal::Type::HashOf[-> { Integer }, nil?: true]
  ...
  class B < MetronomeSDK::Internal::Type::BaseModel
    optional :a, Integer
    optional :b, B
  end
  ...
  def test_typing
    converters = [
      MetronomeSDK::Internal::Type::Unknown,
      MetronomeSDK::Internal::Type::Boolean,
      A,
      H,
      E,
      U,
    ...
    converters.each do |conv|
      assert_pattern do
        conv => MetronomeSDK::Internal::Type::Converter
      end
    end
  end
  ...
  def test_coerce
    cases = {
      [MetronomeSDK::Internal::Type::Unknown, :a] => [{yes: 1}, :a],
      [NilClass, :a] => [{maybe: 1}, nil],
      [NilClass, nil] => [{yes: 1}, nil],
      [MetronomeSDK::Internal::Type::Boolean, true] => [{yes: 1}, true],
      [MetronomeSDK::Internal::Type::Boolean, "true"] => [{no: 1}, "true"],
      [Integer, 1] => [{yes: 1}, 1],
    ...
    cases.each do |lhs, rhs|
      ...
      state = MetronomeSDK::Internal::Type::Converter.new_coerce_state
      assert_pattern do
        MetronomeSDK::Internal::Type::Converter.coerce(target, input, state: state) => ^expect
  ...
  def test_dump
    cases = {
      [MetronomeSDK::Internal::Type::Unknown, B.new(a: "one", b: B.new(a: 1.0))] => {a: "one", b: {a: 1}},
      ...
      [MetronomeSDK::Internal::Type::Boolean, true] => true,
      [MetronomeSDK::Internal::Type::Boolean, "true"] => "true",
      [Integer, "1"] => "1",
      [Float, 1] => 1,
      [String, "one"] => "one",
      ...
      [String, Pathname(__FILE__)] => MetronomeSDK::FilePart
    }
    ...
    cases.each do
      ...
      expect = _2
      assert_pattern do
        MetronomeSDK::Internal::Type::Converter.dump(target, input) => ^expect
      end
    end
  end
  ...
  def test_coerce_errors
    ...
    cases.each do |testcase, expect|
      ...
      state = MetronomeSDK::Internal::Type::Converter.new_coerce_state
      MetronomeSDK::Internal::Type::Converter.coerce(target, input, state: state)
      assert_pattern do
        state => {error: ^expect}
      end
    end
  ...
  def test_dump_retry
    ...
    Pathname(__FILE__).open do |fd|
      ...
      types.product(cases).each do |target, input|
        ...
        MetronomeSDK::Internal::Type::Converter.dump(target, input, state: state)
...
class MetronomeSDK::Test::EnumModelTest < Minitest::Test
  class E0
    include MetronomeSDK::Internal::Type::Enum
...
class MetronomeSDK::Test::CollectionModelTest < Minitest::Test
  A1 = MetronomeSDK::Internal::Type::ArrayOf[-> { Integer }]
  H1 = MetronomeSDK::Internal::Type::HashOf[Integer]

  A2 = MetronomeSDK::Internal::Type::ArrayOf[H1]
  H2 = MetronomeSDK::Internal::Type::HashOf[-> { A1 }]

  A3 = MetronomeSDK::Internal::Type::ArrayOf[Integer, nil?: true]
  H3 = MetronomeSDK::Internal::Type::HashOf[Integer, nil?: true]
...
class MetronomeSDK::Test::BaseModelTest < Minitest::Test
  class M1 < MetronomeSDK::Internal::Type::BaseModel
    required :a, Integer
  end
  ...
  class M3 < MetronomeSDK::Internal::Type::BaseModel
    optional :c, const: :c
    required :d, const: :d
  end
  ...
  class M5 < MetronomeSDK::Internal::Type::BaseModel
    request_only do
      required :c, const: :c
    end
  ...
  class M6 < M1
    required :a, MetronomeSDK::Internal::Type::ArrayOf[M6]
    optional :b, M6
  end
  ...
  def test_coerce
    ...
    cases.each do |lhs, rhs|
      ...
      state = MetronomeSDK::Internal::Type::Converter.new_coerce_state
      assert_pattern do
        coerced = MetronomeSDK::Internal::Type::Converter.coerce(target, input, state: state)
        assert_equal(coerced, coerced)
        if coerced.is_a?(MetronomeSDK::Internal::Type::BaseModel)
          coerced.to_h => ^expect
        else
          coerced => ^expect
        end
      ...
      attributes.each do |accessor, expect|
        ...
        in Class if expect <= StandardError
          tap do
            ...
            flunk
          rescue MetronomeSDK::Errors::ConversionError => e
...
class MetronomeSDK::Test::UnionTest < Minitest::Test
  class U0
    include MetronomeSDK::Internal::Type::Union
  ...
  class M2 < MetronomeSDK::Internal::Type::BaseModel
  ...
  class M4 < MetronomeSDK::Internal::Type::BaseModel
    optional :recur, -> { U5 }
    required :a, MetronomeSDK::Internal::Type::ArrayOf[-> { U5 }]
  end

  class M5 < MetronomeSDK::Internal::Type::BaseModel
    optional :recur, -> { U5 }
    required :b, MetronomeSDK::Internal::Type::ArrayOf[-> { U5 }]
  end
...
class MetronomeSDK::Test::BaseModelQoLTest < Minitest::Test
  class E0
    include MetronomeSDK::Internal::Type::Enum
  ...
  def test_equality
    cases = {
      [MetronomeSDK::Internal::Type::Unknown, MetronomeSDK::Internal::Type::Unknown] => true,
      [MetronomeSDK::Internal::Type::Boolean, MetronomeSDK::Internal::Type::Boolean] => true,
      [MetronomeSDK::Internal::Type::Unknown, MetronomeSDK::Internal::Type::Boolean] => false,
...
class MetronomeSDK::Test::MetaInfoTest < Minitest::Test
  A1 = MetronomeSDK::Internal::Type::ArrayOf[Integer, nil?: true, doc: "dog"]
  H1 = MetronomeSDK::Internal::Type::HashOf[-> { String }, nil?: true, doc: "dawg"]
