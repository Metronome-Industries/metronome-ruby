...
class MetronomeSDK::Test::SingletonClient < MetronomeSDK::Client
  include Singleton

  TEST_API_BASE_URL = ENV.fetch("TEST_API_BASE_URL", "http://localhost:4010")

  def initialize
    super(base_url: MetronomeSDK::Test::SingletonClient::TEST_API_BASE_URL, bearer_token: "My Bearer Token")
  end
end
...
class MetronomeSDK::Test::ResourceTest < Minitest::Test
  def async?
  ...
  def before_all
    super
    @metronome = MetronomeSDK::Test::SingletonClient.instance
  end
