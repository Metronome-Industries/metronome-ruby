...
class MetronomeSDKTest < Minitest::Test
  ...
  def test_raises_on_missing_non_nullable_opts
    e = assert_raises(ArgumentError) do
      MetronomeSDK::Client.new
    end
    assert_match(/is required/, e.message)
  end

  def test_client_default_request_default_retry_attempts
    stub_request(:post, "http://localhost/v1/contracts/create").to_return_json(status: 500, body: {})

    metronome = MetronomeSDK::Client.new(base_url: "http://localhost", bearer_token: "My Bearer Token")
  ...
  def test_client_given_request_default_retry_attempts
    ...
    metronome =
      MetronomeSDK::Client.new(base_url: "http://localhost", bearer_token: "My Bearer Token", max_retries: 3)
  ...
  def test_client_redirect_307
    ...
    assert_raises(MetronomeSDK::Errors::APIConnectionError) do
      metronome.v1.contracts.create(
        customer_id: "13117714-3f05-48e5-a6e9-a66093f13b4d",
        starting_at: "2020-01-01T00:00:00.000Z",
    ...
    assert_requested(:any, "http://localhost/redirected", times: MetronomeSDK::Client::MAX_REDIRECTS) do
  ...
  def test_client_redirect_303
    ...
    assert_requested(:get, "http://localhost/redirected", times: MetronomeSDK::Client::MAX_REDIRECTS) do
  ...
  def test_client_redirect_auth_strip_cross_origin
    ...
    assert_requested(:any, "https://example.com/redirected", times: MetronomeSDK::Client::MAX_REDIRECTS) do
      headers = _1.headers.keys.map(&:downcase)
  ...
  def test_default_headers
    stub_request(:post, "http://localhost/v1/contracts/create").to_return_json(status: 200, body: {})
