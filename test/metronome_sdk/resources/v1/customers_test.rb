...
class MetronomeSDK::Test::Resources::V1::CustomersTest < MetronomeSDK::Test::ResourceTest
  ...
  def test_retrieve_customer_billing_configurations_required_params
    response =
      @metronome.v1.customers.retrieve_customer_billing_configurations(
        customer_id: "6a37bb88-8538-48c5-b37b-a41c836328bd"
      )

    assert_pattern do
      response => MetronomeSDK::Models::V1::CustomerRetrieveCustomerBillingConfigurationsResponse
    end

    assert_pattern do
      response => {
        data: ^(MetronomeSDK::Internal::Type::ArrayOf[MetronomeSDK::Models::V1::CustomerRetrieveCustomerBillingConfigurationsResponse::Data])
      }
    end
  end

  def test_set_customer_billing_configurations_required_params
    response =
      @metronome.v1.customers.set_customer_billing_configurations(
        data: [
