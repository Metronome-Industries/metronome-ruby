...
class MetronomeSDKTest < Minitest::Test
  ...
  def test_client_default_request_default_retry_attempts
    metronome = MetronomeSDK::Client.new(base_url: "http://localhost:4010", bearer_token: "My Bearer Token")
    requester = MockRequester.new(500, {}, {})
    metronome.requester = requester

    assert_raises(MetronomeSDK::InternalServerError) do
  ...
  def test_client_redirect_307
    ...
    assert_raises(MetronomeSDK::APIConnectionError) do
      metronome.v1.contracts.create(
        customer_id: "13117714-3f05-48e5-a6e9-a66093f13b4d",
        starting_at: "2020-01-01T00:00:00.000Z",
