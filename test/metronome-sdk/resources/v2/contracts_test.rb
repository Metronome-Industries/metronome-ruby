...
class MetronomeSDK::Test::Resources::V2::ContractsTest < Minitest::Test
  def before_all
  ...
  def test_retrieve_required_params
    response = @metronome.v2.contracts.retrieve(
  ...
  def test_list_required_params
    ...
    assert_pattern do
      response => {
        data: ^(MetronomeSDK::ArrayOf[MetronomeSDK::Models::V2::ContractListResponse::Data])
      }
    end
  end
  ...
  def test_get_edit_history_required_params
    ...
    assert_pattern do
      response => {
        data: ^(MetronomeSDK::ArrayOf[MetronomeSDK::Models::V2::ContractGetEditHistoryResponse::Data])
      }
    end
  end
end
