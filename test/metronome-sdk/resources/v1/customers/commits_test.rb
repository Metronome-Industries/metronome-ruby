...
class MetronomeSDK::Test::Resources::V1::Customers::CommitsTest < Minitest::Test
  def before_all
  ...
  def test_create_required_params
    response = @metronome.v1.customers.commits.create(
      access_schedule: {
        schedule_items: [
          {
            amount: 1000,
  ...
  def test_list_required_params
    ...
    assert_pattern do
      response => {
        data: ^(MetronomeSDK::ArrayOf[MetronomeSDK::Models::Commit]),
