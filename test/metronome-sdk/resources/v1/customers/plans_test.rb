...
class MetronomeSDK::Test::Resources::V1::Customers::PlansTest < Minitest::Test
  def before_all
  ...
  def test_list_price_adjustments_required_params
    response = @metronome.v1.customers.plans.list_price_adjustments(
      customer_id: "d7abd0cd-4ae9-4db7-8676-e986a4ebd8dc",
      customer_plan_id: "7aa11640-0703-4600-8eb9-293f535a6b74"
    )
    ...
    assert_pattern do
      row => {
        ...
        prices: ^(MetronomeSDK::ArrayOf[MetronomeSDK::Models::V1::Customers::PlanListPriceAdjustmentsResponse::Price]),
        start_period: Float,
        quantity: Float | nil
      }
    end
