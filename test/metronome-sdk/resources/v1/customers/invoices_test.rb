...
class MetronomeSDK::Test::Resources::V1::Customers::InvoicesTest < Minitest::Test
  def before_all
  ...
  def test_retrieve_required_params
    response = @metronome.v1.customers.invoices.retrieve(
  ...
  def test_list_required_params
    ...
    assert_pattern do
      row => {
        ...
        customer_id: String,
        line_items: ^(MetronomeSDK::ArrayOf[MetronomeSDK::Models::V1::Customers::Invoice::LineItem]),
        status: String,
        total: Float,
        type: String,
        amendment_id: String | nil,
        billable_status: MetronomeSDK::Models::V1::Customers::Invoice::BillableStatus | nil,
        contract_custom_fields: ^(MetronomeSDK::HashOf[String]) | nil,
        contract_id: String | nil,
        correction_record: MetronomeSDK::Models::V1::Customers::Invoice::CorrectionRecord | nil,
        created_at: Time | nil,
        custom_fields: ^(MetronomeSDK::HashOf[MetronomeSDK::Unknown]) | nil,
        customer_custom_fields: ^(MetronomeSDK::HashOf[String]) | nil,
        end_timestamp: Time | nil,
        external_invoice: MetronomeSDK::Models::V1::Customers::Invoice::ExternalInvoice | nil,
        invoice_adjustments: ^(MetronomeSDK::ArrayOf[MetronomeSDK::Models::V1::Customers::Invoice::InvoiceAdjustment]) | nil,
        issued_at: Time | nil,
        net_payment_terms_days: Float | nil,
        netsuite_sales_order_id: String | nil,
        plan_custom_fields: ^(MetronomeSDK::HashOf[String]) | nil,
        plan_id: String | nil,
  ...
  def test_list_breakdowns_required_params
    response = @metronome.v1.customers.invoices.list_breakdowns(
      customer_id: "d7abd0cd-4ae9-4db7-8676-e986a4ebd8dc",
