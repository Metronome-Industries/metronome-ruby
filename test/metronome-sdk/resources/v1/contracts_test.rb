...
class MetronomeSDK::Test::Resources::V1::ContractsTest < Minitest::Test
  def before_all
  ...
  def test_create_required_params
    response = @metronome.v1.contracts.create(
  ...
  def test_retrieve_required_params
    response = @metronome.v1.contracts.retrieve(
  ...
  def test_list_required_params
    ...
    assert_pattern do
      response => {
        data: ^(MetronomeSDK::ArrayOf[MetronomeSDK::Models::V1::ContractListResponse::Data])
      }
    end
  end

  def test_add_manual_balance_entry_required_params
    response = @metronome.v1.contracts.add_manual_balance_entry(
  ...
  def test_create_historical_invoices_required_params
    ...
    assert_pattern do
      response => {
        data: ^(MetronomeSDK::ArrayOf[MetronomeSDK::Models::V1::Customers::Invoice])
      }
    end
  end
  ...
  def test_list_balances_required_params
    ...
    assert_pattern do
      response => {
        data: ^(MetronomeSDK::ArrayOf[union: MetronomeSDK::Models::V1::ContractListBalancesResponse::Data]),
  ...
  def test_retrieve_rate_schedule_required_params
    ...
    assert_pattern do
      response => {
        data: ^(MetronomeSDK::ArrayOf[MetronomeSDK::Models::V1::ContractRetrieveRateScheduleResponse::Data]),
        next_page: String | nil
      }
    end
  end
  ...
  def test_set_usage_filter_required_params
    response = @metronome.v1.contracts.set_usage_filter(
      contract_id: "d7abd0cd-4ae9-4db7-8676-e986a4ebd8dc",
      customer_id: "13117714-3f05-48e5-a6e9-a66093f13b4d",
