...
class MetronomeSDK::Test::Resources::V1::CreditGrantsTest < Minitest::Test
  def before_all
  ...
  def test_create_required_params
    response = @metronome.v1.credit_grants.create(
  ...
  def test_list
    ...
    assert_pattern do
      row => {
        ...
        customer_id: String,
        deductions: ^(MetronomeSDK::ArrayOf[MetronomeSDK::Models::V1::CreditLedgerEntry]),
        effective_at: Time,
        expires_at: Time,
        ...
        pending_deductions: ^(MetronomeSDK::ArrayOf[MetronomeSDK::Models::V1::CreditLedgerEntry]),
        priority: Float,
        credit_grant_type: String | nil,
        invoice_id: String | nil,
        products: ^(MetronomeSDK::ArrayOf[MetronomeSDK::Models::V1::CreditGrantListResponse::Product]) | nil,
        reason: String | nil,
  ...
  def test_list_entries
    ...
    assert_pattern do
      response => {
        data: ^(MetronomeSDK::ArrayOf[MetronomeSDK::Models::V1::CreditGrantListEntriesResponse::Data]),
