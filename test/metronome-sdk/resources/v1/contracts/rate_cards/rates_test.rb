...
class MetronomeSDK::Test::Resources::V1::Contracts::RateCards::RatesTest < Minitest::Test
  def before_all
  ...
  def test_list_required_params
    response = @metronome.v1.contracts.rate_cards.rates.list(
    ...
    assert_pattern do
      row => {
        entitled: MetronomeSDK::BooleanModel,
        product_custom_fields: ^(MetronomeSDK::HashOf[String]),
        product_id: String,
        product_name: String,
        product_tags: ^(MetronomeSDK::ArrayOf[String]),
        ...
        pricing_group_values: ^(MetronomeSDK::HashOf[String]) | nil
      }
    end
  end
