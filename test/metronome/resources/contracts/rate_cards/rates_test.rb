...
class Metronome::Test::Resources::RatesTest < Test::Unit::TestCase
  def setup
  ...
  def test_add_required_params
    response = @metronome.contracts.rate_cards.rates.add(
      {entitled: true, product_id: "13117714-3f05-48e5-a6e9-a66093f13b4d", rate_card_id: "d7abd0cd-4ae9-4db7-8676-e986a4ebd8dc", rate_type: "FLAT", starting_at: "2020-01-01T00:00:00.000Z"}
    )
