...
class Metronome::Test::Resources::Contracts::RateCardsTest < Test::Unit::TestCase
  def setup
  ...
  def test_retrieve_rate_schedule_required_params
    ...
    assert_kind_of(Metronome::Models::RateCardRetrieveRateScheduleResponse, response)
  end
end
