...
Most of the SDK is generated code. Modifications to code will be persisted between generations, but may result in merge conflicts between manual patches and changes from the generator. The generator will never modify the contents of `lib/metronome_sdk/helpers/` and `examples/` directory.
...
require_relative "../lib/metronome_sdk"
...
```ruby
gem "metronome-sdk", git: "https://www.github.com/Metronome-Industries/metronome-ruby"
```

Alternatively, reference local copy of the repo:

```bash
$ git clone -- 'https://www.github.com/Metronome-Industries/metronome-ruby' '<path-to-repo>'
```

```ruby
gem "metronome-sdk", path: "<path-to-repo>"
```
