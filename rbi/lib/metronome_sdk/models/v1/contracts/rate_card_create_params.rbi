      ...
      module Contracts
        class RateCardCreateParams < MetronomeSDK::Internal::Type::BaseModel
          ...
          class CreditTypeConversion < MetronomeSDK::Internal::Type::BaseModel
            ...
            sig do
              params(custom_credit_type_id: String, fiat_per_custom_credit: Float).returns(T.attached_class)
            end
            def self.new(custom_credit_type_id:, fiat_per_custom_credit:); end
