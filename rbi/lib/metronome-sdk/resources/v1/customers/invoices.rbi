        ...
        class Invoices
          ...
          sig do
            params(
              ...
              .returns(MetronomeSDK::CursorPage[MetronomeSDK::Models::V1::Customers::Invoice])
          end
          def list(
            customer_id:,
            credit_type_id: nil,
          ...
          sig do
            params(
              ...
              .returns(MetronomeSDK::CursorPage[MetronomeSDK::Models::V1::Customers::InvoiceListBreakdownsResponse])
          end
          def list_breakdowns(
            customer_id:,
            ending_before:,
