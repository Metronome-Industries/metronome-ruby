...
module MetronomeSDK
  class BaseClient
    ...
    RequestComponentsShape = T.type_alias do
      {
        ...
        page: T.nilable(T::Class[MetronomeSDK::BaseModel]),
        model: T.nilable(MetronomeSDK::Converter::Input),
        options: T.nilable(T.any(MetronomeSDK::RequestOptions, T::Hash[Symbol, T.anything]))
      }
    end
    ...
    sig { params(req: MetronomeSDK::BaseClient::RequestComponentsShape).void }
    ...
    sig do
      params(
        request: MetronomeSDK::BaseClient::RequestInputShape,
        status: Integer,
        response_headers: T.any(T::Hash[String, String], Net::HTTPHeader)
      )
        .returns(MetronomeSDK::BaseClient::RequestInputShape)
    end
    ...
    sig do
      overridable
        .params(req: MetronomeSDK::BaseClient::RequestComponentsShape, opts: T::Hash[Symbol, T.anything])
        .returns(MetronomeSDK::BaseClient::RequestInputShape)
    end
