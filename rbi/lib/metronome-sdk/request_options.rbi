...
module MetronomeSDK
  module RequestParameters
    ...
    sig { returns(T.any(MetronomeSDK::RequestOptions, T::Hash[Symbol, T.anything])) }
    def request_options
    end

    sig do
      params(_: T.any(MetronomeSDK::RequestOptions, T::Hash[Symbol, T.anything]))
        .returns(T.any(MetronomeSDK::RequestOptions, T::Hash[Symbol, T.anything]))
    end
