...
module MetronomeSDK
  module Converter
    ...
    Input = T.type_alias { T.any(MetronomeSDK::Converter, T::Class[T.anything]) }
        ...
        spec: T.any(
          {
            ...
            enum: T.nilable(T.proc.returns(MetronomeSDK::Converter::Input)),
            union: T.nilable(T.proc.returns(MetronomeSDK::Converter::Input))
          },
          T.proc.returns(MetronomeSDK::Converter::Input),
          MetronomeSDK::Converter::Input
        )
      )
    ...
    sig { params(target: MetronomeSDK::Converter::Input, value: T.anything).returns(T.anything) }
  ...
  class Union
    ...
    sig { params(value: T.anything).returns(T.nilable(MetronomeSDK::Converter::Input)) }
  ...
  class ArrayOf
    ...
    sig { returns(MetronomeSDK::Converter::Input) }
  ...
  class BaseModel
    ...
    sig do
      returns(
        ...
        Symbol,
        T.all(
          MetronomeSDK::BaseModel::KnownFieldShape,
          {type_fn: T.proc.returns(MetronomeSDK::Converter::Input)}
        )
        ]
      )
    end
    ...
    sig do
      returns(
        T::Hash[Symbol,
                T.all(MetronomeSDK::BaseModel::KnownFieldShape, {type: MetronomeSDK::Converter::Input})]
      )
    end
    def self.fields
    end
    ...
    sig do
      override
        .params(value: T.any(MetronomeSDK::BaseModel, T::Hash[T.anything, T.anything], T.anything))
