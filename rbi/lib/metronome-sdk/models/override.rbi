...
module MetronomeSDK
  module Models
    class Override < MetronomeSDK::BaseModel
      ...
      sig do
        params(_: T::Array[MetronomeSDK::Models::Override::OverrideSpecifier])
          .returns(T::Array[MetronomeSDK::Models::Override::OverrideSpecifier])
      end
      ...
      sig do
        params(_: T::Array[MetronomeSDK::Models::Override::OverrideTier])
          .returns(T::Array[MetronomeSDK::Models::Override::OverrideTier])
      end
      ...
      sig do
        params(_: MetronomeSDK::Models::Override::OverwriteRate)
          .returns(MetronomeSDK::Models::Override::OverwriteRate)
      end
      ...
      sig { params(_: MetronomeSDK::Models::Override::Product).returns(MetronomeSDK::Models::Override::Product) }
      def product=(_)
      end
