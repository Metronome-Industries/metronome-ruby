      ...
      module Contracts
        module RateCards
          class RateListResponse < MetronomeSDK::BaseModel
            ...
            sig do
              params(_: MetronomeSDK::Models::V1::Contracts::RateCards::RateListResponse::CommitRate)
                .returns(MetronomeSDK::Models::V1::Contracts::RateCards::RateListResponse::CommitRate)
            end
            def commit_rate=(_)
            end
