      ...
      module Contracts
        module RateCards
          class RateAddParams < MetronomeSDK::BaseModel
            ...
            sig do
              params(_: MetronomeSDK::Models::V1::Contracts::RateCards::RateAddParams::CommitRate)
                .returns(MetronomeSDK::Models::V1::Contracts::RateCards::RateAddParams::CommitRate)
            end
            def commit_rate=(_)
            end
