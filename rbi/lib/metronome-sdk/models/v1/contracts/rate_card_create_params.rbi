    ...
    module V1
      module Contracts
        class RateCardCreateParams < MetronomeSDK::BaseModel
          ...
          sig { returns(T.nilable(T::Array[MetronomeSDK::Models::V1::Contracts::RateCardCreateParams::Alias])) }
          def aliases
          end

          sig do
            params(_: T::Array[MetronomeSDK::Models::V1::Contracts::RateCardCreateParams::Alias])
              .returns(T::Array[MetronomeSDK::Models::V1::Contracts::RateCardCreateParams::Alias])
          end
          def aliases=(_)
          end
          ...
          sig do
            returns(
              T.nilable(T::Array[MetronomeSDK::Models::V1::Contracts::RateCardCreateParams::CreditTypeConversion])
            )
          end
          ...
          sig do
            params(_: T::Array[MetronomeSDK::Models::V1::Contracts::RateCardCreateParams::CreditTypeConversion])
              .returns(T::Array[MetronomeSDK::Models::V1::Contracts::RateCardCreateParams::CreditTypeConversion])
          end
