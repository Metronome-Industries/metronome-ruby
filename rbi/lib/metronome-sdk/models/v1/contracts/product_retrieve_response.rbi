...
module MetronomeSDK
  module Models
    module V1
      module Contracts
        class ProductRetrieveResponse < MetronomeSDK::BaseModel
          sig { returns(MetronomeSDK::Models::V1::Contracts::ProductRetrieveResponse::Data) }
          def data
          end

          sig do
            params(_: MetronomeSDK::Models::V1::Contracts::ProductRetrieveResponse::Data)
              .returns(MetronomeSDK::Models::V1::Contracts::ProductRetrieveResponse::Data)
          end
          def data=(_)
          end

          sig { params(data: MetronomeSDK::Models::V1::Contracts::ProductRetrieveResponse::Data).void }
          def initialize(data:)
          end
          ...
          class Data < MetronomeSDK::BaseModel
            ...
            sig do
              params(_: T::Array[MetronomeSDK::Models::V1::Contracts::ProductRetrieveResponse::Data::Update])
                .returns(T::Array[MetronomeSDK::Models::V1::Contracts::ProductRetrieveResponse::Data::Update])
            end
            def updates=(_)
            end
