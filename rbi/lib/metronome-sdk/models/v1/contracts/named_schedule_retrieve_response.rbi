    ...
    module V1
      module Contracts
        class NamedScheduleRetrieveResponse < MetronomeSDK::BaseModel
          ...
          sig do
            params(_: T::Array[MetronomeSDK::Models::V1::Contracts::NamedScheduleRetrieveResponse::Data])
              .returns(T::Array[MetronomeSDK::Models::V1::Contracts::NamedScheduleRetrieveResponse::Data])
          end
          def data=(_)
          end

          sig { params(data: T::Array[MetronomeSDK::Models::V1::Contracts::NamedScheduleRetrieveResponse::Data]).void }
          def initialize(data:)
          end
