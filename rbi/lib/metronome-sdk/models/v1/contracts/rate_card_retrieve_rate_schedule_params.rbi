    ...
    module V1
      module Contracts
        class RateCardRetrieveRateScheduleParams < MetronomeSDK::BaseModel
          ...
          sig do
            params(_: T::Array[MetronomeSDK::Models::V1::Contracts::RateCardRetrieveRateScheduleParams::Selector])
              .returns(T::Array[MetronomeSDK::Models::V1::Contracts::RateCardRetrieveRateScheduleParams::Selector])
          end
          def selectors=(_)
          end
