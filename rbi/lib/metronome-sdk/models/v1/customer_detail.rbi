  ...
  module Models
    module V1
      class CustomerDetail < MetronomeSDK::BaseModel
        ...
        sig do
          params(_: MetronomeSDK::Models::V1::CustomerDetail::CustomerConfig)
            .returns(MetronomeSDK::Models::V1::CustomerDetail::CustomerConfig)
        end
        ...
        sig do
          params(_: MetronomeSDK::Models::V1::CustomerDetail::CurrentBillableStatus)
            .returns(MetronomeSDK::Models::V1::CustomerDetail::CurrentBillableStatus)
        end
