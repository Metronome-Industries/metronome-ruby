  ...
  module Models
    module V1
      class ContractListResponse < MetronomeSDK::BaseModel
        ...
        sig do
          params(_: T::Array[MetronomeSDK::Models::V1::ContractListResponse::Data])
            .returns(T::Array[MetronomeSDK::Models::V1::ContractListResponse::Data])
        end
        def data=(_)
        end

        sig { params(data: T::Array[MetronomeSDK::Models::V1::ContractListResponse::Data]).void }
        def initialize(data:)
        end
        ...
        class Data < MetronomeSDK::BaseModel
          ...
          sig do
            params(_: T::Array[MetronomeSDK::Models::V1::ContractListResponse::Data::Amendment])
              .returns(T::Array[MetronomeSDK::Models::V1::ContractListResponse::Data::Amendment])
          end
          def amendments=(_)
          end
          ...
          sig do
            params(_: MetronomeSDK::Models::V1::ContractListResponse::Data::CustomerBillingProviderConfiguration)
              .returns(MetronomeSDK::Models::V1::ContractListResponse::Data::CustomerBillingProviderConfiguration)
          end
          ...
          class Amendment < MetronomeSDK::BaseModel
            ...
            sig do
              params(_: T::Array[MetronomeSDK::Models::V1::ContractListResponse::Data::Amendment::ResellerRoyalty])
                .returns(T::Array[MetronomeSDK::Models::V1::ContractListResponse::Data::Amendment::ResellerRoyalty])
            end
