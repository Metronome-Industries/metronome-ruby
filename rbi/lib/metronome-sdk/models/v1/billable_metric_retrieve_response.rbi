...
module MetronomeSDK
  module Models
    module V1
      class BillableMetricRetrieveResponse < MetronomeSDK::BaseModel
        sig { returns(MetronomeSDK::Models::V1::BillableMetricRetrieveResponse::Data) }
        def data
        end

        sig do
          params(_: MetronomeSDK::Models::V1::BillableMetricRetrieveResponse::Data)
            .returns(MetronomeSDK::Models::V1::BillableMetricRetrieveResponse::Data)
        end
        def data=(_)
        end

        sig { params(data: MetronomeSDK::Models::V1::BillableMetricRetrieveResponse::Data).void }
        def initialize(data:)
        end
