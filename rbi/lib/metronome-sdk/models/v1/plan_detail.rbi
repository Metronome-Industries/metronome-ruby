  ...
  module Models
    module V1
      class PlanDetail < MetronomeSDK::BaseModel
        ...
        sig do
          params(_: T::Array[MetronomeSDK::Models::V1::PlanDetail::CreditGrant])
            .returns(T::Array[MetronomeSDK::Models::V1::PlanDetail::CreditGrant])
        end
        def credit_grants=(_)
        end
        ...
        sig do
          params(_: T::Array[MetronomeSDK::Models::V1::PlanDetail::Minimum])
            .returns(T::Array[MetronomeSDK::Models::V1::PlanDetail::Minimum])
        end
        def minimums=(_)
        end
        ...
        sig do
          params(_: T::Array[MetronomeSDK::Models::V1::PlanDetail::OverageRate])
            .returns(T::Array[MetronomeSDK::Models::V1::PlanDetail::OverageRate])
        end
        def overage_rates=(_)
        end
        ...
        class Minimum < MetronomeSDK::BaseModel
          ...
          sig do
            params(credit_type: MetronomeSDK::Models::CreditTypeData, name: String, start_period: Float, value: Float)
              .void
          end
