  ...
  module Models
    module V1
      class UsageListResponse < MetronomeSDK::BaseModel
        ...
        sig do
          params(_: T::Array[MetronomeSDK::Models::V1::UsageListResponse::Data])
        ...
        sig do
          params(data: T::Array[MetronomeSDK::Models::V1::UsageListResponse::Data], next_page: T.nilable(String))
            .void
        end
