  ...
  module Models
    module V1
      class ContractScheduleProServicesInvoiceParams < MetronomeSDK::BaseModel
        ...
        sig do
          params(_: T::Array[MetronomeSDK::Models::V1::ContractScheduleProServicesInvoiceParams::LineItem])
            .returns(T::Array[MetronomeSDK::Models::V1::ContractScheduleProServicesInvoiceParams::LineItem])
        end
        def line_items=(_)
        end
