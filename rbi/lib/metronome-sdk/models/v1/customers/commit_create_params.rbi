    ...
    module V1
      module Customers
        class CommitCreateParams < MetronomeSDK::BaseModel
          ...
          sig do
            params(_: MetronomeSDK::Models::V1::Customers::CommitCreateParams::AccessSchedule)
              .returns(MetronomeSDK::Models::V1::Customers::CommitCreateParams::AccessSchedule)
          end
          ...
          sig do
            params(_: MetronomeSDK::Models::V1::Customers::CommitCreateParams::InvoiceSchedule)
              .returns(MetronomeSDK::Models::V1::Customers::CommitCreateParams::InvoiceSchedule)
          end
          ...
          class AccessSchedule < MetronomeSDK::BaseModel
            ...
            sig do
              params(_: T::Array[MetronomeSDK::Models::V1::Customers::CommitCreateParams::AccessSchedule::ScheduleItem])
                .returns(T::Array[MetronomeSDK::Models::V1::Customers::CommitCreateParams::AccessSchedule::ScheduleItem])
            end
          ...
          class InvoiceSchedule < MetronomeSDK::BaseModel
            ...
            sig do
              params(_: MetronomeSDK::Models::V1::Customers::CommitCreateParams::InvoiceSchedule::RecurringSchedule)
                .returns(MetronomeSDK::Models::V1::Customers::CommitCreateParams::InvoiceSchedule::RecurringSchedule)
            end
            ...
            sig do
              params(
                _: T::Array[MetronomeSDK::Models::V1::Customers::CommitCreateParams::InvoiceSchedule::ScheduleItem]
              )
                .returns(T::Array[MetronomeSDK::Models::V1::Customers::CommitCreateParams::InvoiceSchedule::ScheduleItem])
            end
            def schedule_items=(_)
            end
