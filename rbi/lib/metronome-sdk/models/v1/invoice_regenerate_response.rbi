  ...
  module Models
    module V1
      class InvoiceRegenerateResponse < MetronomeSDK::BaseModel
        ...
        sig do
          params(_: MetronomeSDK::Models::V1::InvoiceRegenerateResponse::Data)
            .returns(MetronomeSDK::Models::V1::InvoiceRegenerateResponse::Data)
        end
        def data=(_)
        end

        sig { params(data: MetronomeSDK::Models::V1::InvoiceRegenerateResponse::Data).void }
