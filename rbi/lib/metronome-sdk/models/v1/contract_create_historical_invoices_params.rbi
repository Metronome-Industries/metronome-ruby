  ...
  module Models
    module V1
      class ContractCreateHistoricalInvoicesParams < MetronomeSDK::BaseModel
        ...
        sig do
          params(_: T::Array[MetronomeSDK::Models::V1::ContractCreateHistoricalInvoicesParams::Invoice])
            .returns(T::Array[MetronomeSDK::Models::V1::ContractCreateHistoricalInvoicesParams::Invoice])
        end
        def invoices=(_)
        end
        ...
        class Invoice < MetronomeSDK::BaseModel
          ...
          sig do
            params(
              _: T::Array[MetronomeSDK::Models::V1::ContractCreateHistoricalInvoicesParams::Invoice::UsageLineItem]
            )
              .returns(
                T::Array[MetronomeSDK::Models::V1::ContractCreateHistoricalInvoicesParams::Invoice::UsageLineItem]
              )
