...
module MetronomeSDK
  class PooledNetRequester
    ...
    sig { params(request: MetronomeSDK::PooledNetRequester::RequestShape).returns(Net::HTTPGenericRequest) }
    ...
    sig do
      params(request: MetronomeSDK::PooledNetRequester::RequestShape)
