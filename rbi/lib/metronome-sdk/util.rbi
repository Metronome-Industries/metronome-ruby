...
module MetronomeSDK
  module Util
    ...
    sig { params(url: T.any(URI::Generic, String)).returns(MetronomeSDK::Util::ParsedUriShape) }
    def self.parse_uri(url)
    end

    sig { params(parsed: MetronomeSDK::Util::ParsedUriShape).returns(URI::Generic) }
    def self.unparse_uri(parsed)
    end

    sig do
      params(lhs: MetronomeSDK::Util::ParsedUriShape, rhs: MetronomeSDK::Util::ParsedUriShape)
        .returns(URI::Generic)
    end
