...
module Metronome
  module Converter
    ...
    Input = T.type_alias { T.any(Metronome::Converter, T::Class[T.anything]) }
        ...
        spec: T.any(
          {
            ...
            enum: T.nilable(T.proc.returns(Metronome::Converter::Input)),
            union: T.nilable(T.proc.returns(Metronome::Converter::Input))
          },
          T.proc.returns(Metronome::Converter::Input),
          Metronome::Converter::Input
        )
      )
    ...
    sig { params(target: Metronome::Converter::Input, value: T.anything).returns(T.anything) }
  ...
  class Union
    ...
    sig { params(value: T.anything).returns(T.nilable(Metronome::Converter::Input)) }
  ...
  class ArrayOf
    ...
    sig { returns(Metronome::Converter::Input) }
  ...
  class BaseModel
    ...
    sig do
      returns(
        T::Hash[Symbol,
                T.all(
                  Metronome::BaseModel::KnownFieldShape,
                  {type_fn: T.proc.returns(Metronome::Converter::Input)}
                )]
      )
    end
    ...
    sig do
      returns(
        T::Hash[Symbol, T.all(Metronome::BaseModel::KnownFieldShape, {type: Metronome::Converter::Input})]
      )
    end
    def self.fields
    end
    ...
    sig do
      override
        .params(value: T.any(Metronome::BaseModel, T::Hash[T.anything, T.anything], T.anything))
