...
module Metronome
  module RequestParameters
    ...
    sig { returns(T.any(Metronome::RequestOptions, T::Hash[Symbol, T.anything])) }
    def request_options
    end

    sig do
      params(_: T.any(Metronome::RequestOptions, T::Hash[Symbol, T.anything]))
        .returns(T.any(Metronome::RequestOptions, T::Hash[Symbol, T.anything]))
    end
