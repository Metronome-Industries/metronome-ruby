...
module Metronome
  module Models
    class ContractListResponse < Metronome::BaseModel
      ...
      sig do
        params(_: T::Array[Metronome::Models::ContractListResponse::Data])
          .returns(T::Array[Metronome::Models::ContractListResponse::Data])
      end
      def data=(_)
      end
      ...
      class Data < Metronome::BaseModel
        ...
        sig do
          params(_: T::Array[Metronome::Models::ContractListResponse::Data::Amendment])
            .returns(T::Array[Metronome::Models::ContractListResponse::Data::Amendment])
        end
        def amendments=(_)
        end
        ...
        sig { returns(T.nilable(Metronome::Models::ContractListResponse::Data::CustomerBillingProviderConfiguration)) }
        def customer_billing_provider_configuration
        end

        sig do
          params(_: Metronome::Models::ContractListResponse::Data::CustomerBillingProviderConfiguration)
            .returns(Metronome::Models::ContractListResponse::Data::CustomerBillingProviderConfiguration)
        end
        ...
        class Amendment < Metronome::BaseModel
          ...
          sig { returns(T.nilable(T::Array[Metronome::Models::ContractListResponse::Data::Amendment::ResellerRoyalty])) }
          def reseller_royalties
          end

          sig do
            params(_: T::Array[Metronome::Models::ContractListResponse::Data::Amendment::ResellerRoyalty])
              .returns(T::Array[Metronome::Models::ContractListResponse::Data::Amendment::ResellerRoyalty])
          end
