  ...
  module Models
    module Contracts
      class RateCardListResponse < Metronome::BaseModel
        ...
        sig { returns(T::Array[Metronome::Models::Contracts::RateCardListResponse::Alias]) }
        attr_reader :aliases

        sig { params(aliases: T::Array[Metronome::Models::Contracts::RateCardListResponse::Alias]).void }
        attr_writer :aliases

        sig { returns(T::Array[Metronome::Models::Contracts::RateCardListResponse::CreditTypeConversion]) }
        ...
        sig { returns(Metronome::Models::Contracts::RateCardListResponse::Shape) }
        def to_h; end
        ...
        class Alias < Metronome::BaseModel
          ...
          sig { returns(Metronome::Models::Contracts::RateCardListResponse::Alias::Shape) }
          def to_h; end
        end
        ...
        class CreditTypeConversion < Metronome::BaseModel
          ...
          sig { returns(Metronome::Models::Contracts::RateCardListResponse::CreditTypeConversion::Shape) }
          def to_h; end
        end
      end
    end
