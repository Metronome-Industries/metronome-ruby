    ...
    module Contracts
      module RateCards
        class RateAddParams < Metronome::BaseModel
          ...
          sig { returns(T.nilable(Metronome::Models::Contracts::RateCards::RateAddParams::CommitRate)) }
          attr_reader :commit_rate

          sig { params(commit_rate: Metronome::Models::Contracts::RateCards::RateAddParams::CommitRate).void }
          ...
          sig { returns(Metronome::Models::Contracts::RateCards::RateAddParams::Shape) }
          def to_h; end
          ...
          class CommitRate < Metronome::BaseModel
            ...
            sig { returns(Metronome::Models::Contracts::RateCards::RateAddParams::CommitRate::Shape) }
            def to_h; end
