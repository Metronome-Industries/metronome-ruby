...
module Metronome
  module Util
    ...
    sig { params(url: T.any(URI::Generic, String)).returns(Metronome::Util::ParsedUriShape) }
    def self.parse_uri(url)
    end

    sig { params(parsed: Metronome::Util::ParsedUriShape).returns(URI::Generic) }
    def self.unparse_uri(parsed)
    end

    sig do
      params(lhs: Metronome::Util::ParsedUriShape, rhs: Metronome::Util::ParsedUriShape).returns(URI::Generic)
    end
