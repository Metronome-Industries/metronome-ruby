  ...
  module Models
    class NotificationRetrieveResponse < MetronomeSDK::Internal::Type::BaseModel
      OrHash =
        T.type_alias do
          T.any(
            MetronomeSDK::Models::NotificationRetrieveResponse,
            MetronomeSDK::Internal::AnyHash
          )
        end

      sig { returns(MetronomeSDK::Models::NotificationRetrieveResponse::Data) }
      attr_reader :data

      sig do
        params(
          data: MetronomeSDK::Models::NotificationRetrieveResponse::Data::OrHash
        ).void
      end
      attr_writer :data
      ...
      class Data < MetronomeSDK::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              MetronomeSDK::Models::NotificationRetrieveResponse::Data,
              MetronomeSDK::Internal::AnyHash
            )
          end
        ...
        sig do
          returns(
            MetronomeSDK::Models::NotificationRetrieveResponse::Data::Policy
          )
        end
        attr_reader :policy
        ...
        sig do
          params(
            policy:
              MetronomeSDK::Models::NotificationRetrieveResponse::Data::Policy::OrHash
          ).void
        end
        attr_writer :policy
