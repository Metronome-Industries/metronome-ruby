      ...
      module Notifications
        class OffsetCreateParams < MetronomeSDK::Internal::Type::BaseModel
          ...
          OrHash =
            T.type_alias do
              T.any(
                MetronomeSDK::V2::Notifications::OffsetCreateParams,
          ...
          # field.
          sig do
            returns(MetronomeSDK::V2::Notifications::OffsetCreateParams::Policy)
          end
          attr_reader :policy
            ...
            override.returns(
              {
                name: String,
                policy:
                  MetronomeSDK::V2::Notifications::OffsetCreateParams::Policy,
                uniqueness_key: String,
