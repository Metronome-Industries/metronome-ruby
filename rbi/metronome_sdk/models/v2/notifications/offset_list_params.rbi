      ...
      module Notifications
        class OffsetListParams < MetronomeSDK::Internal::Type::BaseModel
          ...
          OrHash =
            T.type_alias do
              T.any(
                MetronomeSDK::V2::Notifications::OffsetListParams,
          ...
          module ArchiveFilter
            ...
            TaggedSymbol =
              T.type_alias do
                T.all(
                  Symbol,
                  MetronomeSDK::V2::Notifications::OffsetListParams::ArchiveFilter
                )
              end
            ...
            ARCHIVED =
              T.let(
                :ARCHIVED,
                MetronomeSDK::V2::Notifications::OffsetListParams::ArchiveFilter::TaggedSymbol
              )
            NOT_ARCHIVED =
              T.let(
                :NOT_ARCHIVED,
