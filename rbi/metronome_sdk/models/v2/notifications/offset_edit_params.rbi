      ...
      module Notifications
        class OffsetEditParams < MetronomeSDK::Internal::Type::BaseModel
          ...
          OrHash =
            T.type_alias do
              T.any(
                MetronomeSDK::V2::Notifications::OffsetEditParams,
          ...
          sig do
            returns(
              T.any(
                MetronomeSDK::V2::Notifications::OffsetEditParams::Policy::LifecycleEventOffsetPolicy,
                MetronomeSDK::V2::Notifications::OffsetEditParams::Policy::LifecycleEventSystemPolicy
              )
            )
          end
          ...
          module Policy
            ...
            sig do
              override.returns(
                T::Array[
                  MetronomeSDK::V2::Notifications::OffsetEditParams::Policy::Variants
                ]
              )
            end
            def self.variants
