  ...
  module Models
    module V2
      class ContractEditCommitResponse < MetronomeSDK::Internal::Type::BaseModel
        ...
        sig do
          returns(MetronomeSDK::Models::V2::ContractEditCommitResponse::Data)
        end
        attr_reader :data
        ...
        sig do
          params(
            data:
              MetronomeSDK::Models::V2::ContractEditCommitResponse::Data::OrHash
          ).void
        end
        attr_writer :data
        ...
        class Data < MetronomeSDK::Internal::Type::BaseModel
          OrHash =
            T.type_alias do
              T.any(
                MetronomeSDK::Models::V2::ContractEditCommitResponse::Data,
                MetronomeSDK::Internal::AnyHash
              )
            end
