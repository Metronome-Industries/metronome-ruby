    ...
    module V1
      class CustomerListBillableMetricsResponse < MetronomeSDK::Internal::Type::BaseModel
        ...
        sig do
          params(
            event_type_filter:
              MetronomeSDK::Models::V1::CustomerListBillableMetricsResponse::EventTypeFilter::OrHash
          ).void
        end
        ...
        sig do
          params(
            property_filters:
              T::Array[
                MetronomeSDK::Models::V1::CustomerListBillableMetricsResponse::PropertyFilter::OrHash
              ]
          ).void
        end
