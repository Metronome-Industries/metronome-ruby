        ...
        class Commit < MetronomeSDK::Internal::Type::BaseModel
          ...
          class AccessSchedule < MetronomeSDK::Internal::Type::BaseModel
            ...
            sig do
              returns(
                T.nilable(
                  MetronomeSDK::V1::ContractCreateParams::Commit::AccessSchedule::AccessType::OrSymbol
                )
              )
            end
            ...
            module AccessType
              ...
              TaggedSymbol =
                T.type_alias do
                  T.all(
                    Symbol,
                    MetronomeSDK::V1::ContractCreateParams::Commit::AccessSchedule::AccessType
                  )
                end
              OrSymbol = T.type_alias { T.any(Symbol, String) }
              ...
              SPEND =
                T.let(
                  :SPEND,
                  MetronomeSDK::V1::ContractCreateParams::Commit::AccessSchedule::AccessType::TaggedSymbol
                )
              QUANTITY =
                T.let(
                  :QUANTITY,
        ...
        class Credit < MetronomeSDK::Internal::Type::BaseModel
          ...
          class AccessSchedule < MetronomeSDK::Internal::Type::BaseModel
            ...
            sig do
              returns(
                T.nilable(
                  MetronomeSDK::V1::ContractCreateParams::Credit::AccessSchedule::AccessType::OrSymbol
                )
              )
            end
            attr_reader :access_type
            ...
            module AccessType
              ...
              TaggedSymbol =
                T.type_alias do
                  T.all(
                    Symbol,
                    MetronomeSDK::V1::ContractCreateParams::Credit::AccessSchedule::AccessType
                  )
                end
              OrSymbol = T.type_alias { T.any(Symbol, String) }
              ...
              SPEND =
                T.let(
                  :SPEND,
                  MetronomeSDK::V1::ContractCreateParams::Credit::AccessSchedule::AccessType::TaggedSymbol
                )
              QUANTITY =
                T.let(
                  :QUANTITY,
        ...
        class RecurringCommit < MetronomeSDK::Internal::Type::BaseModel
          ...
          class AccessAmount < MetronomeSDK::Internal::Type::BaseModel
            ...
            sig do
              returns(
                T.nilable(
                  MetronomeSDK::V1::ContractCreateParams::RecurringCommit::AccessAmount::AccessType::OrSymbol
                )
              )
            end
            attr_reader :access_type
            ...
            module AccessType
              ...
              TaggedSymbol =
                T.type_alias do
                  T.all(
                    Symbol,
                    MetronomeSDK::V1::ContractCreateParams::RecurringCommit::AccessAmount::AccessType
                  )
                end
              OrSymbol = T.type_alias { T.any(Symbol, String) }
              ...
              SPEND =
                T.let(
                  :SPEND,
                  MetronomeSDK::V1::ContractCreateParams::RecurringCommit::AccessAmount::AccessType::TaggedSymbol
                )
              QUANTITY =
                T.let(
                  :QUANTITY,
        ...
        class RecurringCredit < MetronomeSDK::Internal::Type::BaseModel
          ...
          class AccessAmount < MetronomeSDK::Internal::Type::BaseModel
            ...
            sig do
              returns(
                T.nilable(
                  MetronomeSDK::V1::ContractCreateParams::RecurringCredit::AccessAmount::AccessType::OrSymbol
                )
              )
            end
            attr_reader :access_type
            ...
            module AccessType
              ...
              TaggedSymbol =
                T.type_alias do
                  T.all(
                    Symbol,
                    MetronomeSDK::V1::ContractCreateParams::RecurringCredit::AccessAmount::AccessType
                  )
                end
              OrSymbol = T.type_alias { T.any(Symbol, String) }
              ...
              SPEND =
                T.let(
                  :SPEND,
                  MetronomeSDK::V1::ContractCreateParams::RecurringCredit::AccessAmount::AccessType::TaggedSymbol
                )
              QUANTITY =
                T.let(
                  :QUANTITY,
