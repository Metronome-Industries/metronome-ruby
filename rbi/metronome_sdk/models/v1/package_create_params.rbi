    ...
    module V1
      class PackageCreateParams < MetronomeSDK::Internal::Type::BaseModel
        ...
        sig do
          returns(
            T.nilable(
              T::Array[MetronomeSDK::V1::PackageCreateParams::SpendTracker]
            )
          )
        end
        ...
        class Commit < MetronomeSDK::Internal::Type::BaseModel
          ...
          class AccessSchedule < MetronomeSDK::Internal::Type::BaseModel
            ...
            sig do
              returns(
                T.nilable(
                  MetronomeSDK::V1::PackageCreateParams::Commit::AccessSchedule::AccessType::OrSymbol
                )
              )
            end
            ...
            module AccessType
              ...
              TaggedSymbol =
                T.type_alias do
                  T.all(
                    Symbol,
                    MetronomeSDK::V1::PackageCreateParams::Commit::AccessSchedule::AccessType
                  )
                end
              OrSymbol = T.type_alias { T.any(Symbol, String) }
              ...
              SPEND =
                T.let(
                  :SPEND,
                  MetronomeSDK::V1::PackageCreateParams::Commit::AccessSchedule::AccessType::TaggedSymbol
                )
              QUANTITY =
                T.let(
                  :QUANTITY,
        ...
        class Credit < MetronomeSDK::Internal::Type::BaseModel
          ...
          class AccessSchedule < MetronomeSDK::Internal::Type::BaseModel
            ...
            sig do
              returns(
                T.nilable(
                  MetronomeSDK::V1::PackageCreateParams::Credit::AccessSchedule::AccessType::OrSymbol
                )
              )
            end
            attr_reader :access_type
            ...
            module AccessType
              ...
              TaggedSymbol =
                T.type_alias do
                  T.all(
                    Symbol,
                    MetronomeSDK::V1::PackageCreateParams::Credit::AccessSchedule::AccessType
                  )
                end
              OrSymbol = T.type_alias { T.any(Symbol, String) }
              ...
              SPEND =
                T.let(
                  :SPEND,
                  MetronomeSDK::V1::PackageCreateParams::Credit::AccessSchedule::AccessType::TaggedSymbol
                )
              QUANTITY =
                T.let(
                  :QUANTITY,
        ...
        class RecurringCommit < MetronomeSDK::Internal::Type::BaseModel
          ...
          class AccessAmount < MetronomeSDK::Internal::Type::BaseModel
            ...
            sig do
              returns(
                T.nilable(
                  MetronomeSDK::V1::PackageCreateParams::RecurringCommit::AccessAmount::AccessType::OrSymbol
                )
              )
            end
            attr_reader :access_type
            ...
            module AccessType
              ...
              TaggedSymbol =
                T.type_alias do
                  T.all(
                    Symbol,
                    MetronomeSDK::V1::PackageCreateParams::RecurringCommit::AccessAmount::AccessType
                  )
                end
              OrSymbol = T.type_alias { T.any(Symbol, String) }
              ...
              SPEND =
                T.let(
                  :SPEND,
                  MetronomeSDK::V1::PackageCreateParams::RecurringCommit::AccessAmount::AccessType::TaggedSymbol
                )
              QUANTITY =
                T.let(
                  :QUANTITY,
        ...
        class RecurringCredit < MetronomeSDK::Internal::Type::BaseModel
          ...
          class AccessAmount < MetronomeSDK::Internal::Type::BaseModel
            ...
            sig do
              returns(
                T.nilable(
                  MetronomeSDK::V1::PackageCreateParams::RecurringCredit::AccessAmount::AccessType::OrSymbol
                )
              )
            end
            attr_reader :access_type
            ...
            module AccessType
              ...
              TaggedSymbol =
                T.type_alias do
                  T.all(
                    Symbol,
                    MetronomeSDK::V1::PackageCreateParams::RecurringCredit::AccessAmount::AccessType
                  )
                end
              OrSymbol = T.type_alias { T.any(Symbol, String) }
              ...
              SPEND =
                T.let(
                  :SPEND,
                  MetronomeSDK::V1::PackageCreateParams::RecurringCredit::AccessAmount::AccessType::TaggedSymbol
                )
              QUANTITY =
                T.let(
                  :QUANTITY,
        ...
        class SpendTracker < MetronomeSDK::Internal::Type::BaseModel
          OrHash =
            T.type_alias do
              T.any(
                MetronomeSDK::V1::PackageCreateParams::SpendTracker,
                MetronomeSDK::Internal::AnyHash
              )
            end
          ...
          sig do
            returns(
              T::Array[
                MetronomeSDK::V1::PackageCreateParams::SpendTracker::ApplicableSpendSpecifier
              ]
            )
          end
          ...
          sig do
            returns(
              MetronomeSDK::V1::PackageCreateParams::SpendTracker::ResetFrequency::OrSymbol
            )
          end
          ...
          sig do
            params(
              ...
              applicable_spend_specifiers:
                T::Array[
                  MetronomeSDK::V1::PackageCreateParams::SpendTracker::ApplicableSpendSpecifier::OrHash
                ],
              credit_type_id: String,
              reset_frequency:
                MetronomeSDK::V1::PackageCreateParams::SpendTracker::ResetFrequency::OrSymbol
          ...
          class ApplicableSpendSpecifier < MetronomeSDK::Internal::Type::BaseModel
            ...
            sig do
              returns(
                T::Array[
                  MetronomeSDK::V1::PackageCreateParams::SpendTracker::ApplicableSpendSpecifier::Source::OrSymbol
                ]
              )
            end
            ...
            sig do
              returns(
                MetronomeSDK::V1::PackageCreateParams::SpendTracker::ApplicableSpendSpecifier::SpendType::OrSymbol
              )
            end
            ...
            sig do
              returns(
                T.nilable(
                  MetronomeSDK::V1::PackageCreateParams::SpendTracker::ApplicableSpendSpecifier::Discounted::OrSymbol
                )
              )
            end
            ...
            module Source
              ...
              TaggedSymbol =
                T.type_alias do
                  T.all(
                    Symbol,
                    MetronomeSDK::V1::PackageCreateParams::SpendTracker::ApplicableSpendSpecifier::Source
                  )
                end
              OrSymbol = T.type_alias { T.any(Symbol, String) }
              ...
              THRESHOLD_RECHARGE =
                T.let(
                  :THRESHOLD_RECHARGE,
                  MetronomeSDK::V1::PackageCreateParams::SpendTracker::ApplicableSpendSpecifier::Source::TaggedSymbol
                )
              MANUAL =
                T.let(
                  :MANUAL,
            ...
            module SpendType
              ...
              TaggedSymbol =
                T.type_alias do
                  T.all(
                    Symbol,
                    MetronomeSDK::V1::PackageCreateParams::SpendTracker::ApplicableSpendSpecifier::SpendType
                  )
                end
              OrSymbol = T.type_alias { T.any(Symbol, String) }
              ...
              COMMIT_PURCHASE =
                T.let(
                  :COMMIT_PURCHASE,
                  MetronomeSDK::V1::PackageCreateParams::SpendTracker::ApplicableSpendSpecifier::SpendType::TaggedSymbol
                )
            ...
            module Discounted
              ...
              TaggedSymbol =
                T.type_alias do
                  T.all(
                    Symbol,
                    MetronomeSDK::V1::PackageCreateParams::SpendTracker::ApplicableSpendSpecifier::Discounted
                  )
                end
              OrSymbol = T.type_alias { T.any(Symbol, String) }
              ...
              ANY =
                T.let(
                  :ANY,
                  MetronomeSDK::V1::PackageCreateParams::SpendTracker::ApplicableSpendSpecifier::Discounted::TaggedSymbol
                )
              DISCOUNTED_ONLY =
                T.let(
                  :DISCOUNTED_ONLY,
          ...
          module ResetFrequency
            ...
            TaggedSymbol =
              T.type_alias do
                T.all(
                  Symbol,
                  MetronomeSDK::V1::PackageCreateParams::SpendTracker::ResetFrequency
                )
              end
            OrSymbol = T.type_alias { T.any(Symbol, String) }
            ...
            BILLING_PERIOD =
              T.let(
                :BILLING_PERIOD,
                MetronomeSDK::V1::PackageCreateParams::SpendTracker::ResetFrequency::TaggedSymbol
              )
