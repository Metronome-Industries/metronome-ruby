  ...
  module Models
    module V1
      class ContractRetrieveRateScheduleResponse < MetronomeSDK::Internal::Type::BaseModel
        ...
        def self.new(data:, next_page: nil); end
        ...
        class Data < MetronomeSDK::Internal::Type::BaseModel
          ...
          sig { params(list_rate: T.any(MetronomeSDK::Models::Rate, MetronomeSDK::Internal::AnyHash)).void }
          ...
          sig { params(override_rate: T.any(MetronomeSDK::Models::Rate, MetronomeSDK::Internal::AnyHash)).void }
          ...
          sig do
            params(
              entitled: T::Boolean,
              list_rate: T.any(MetronomeSDK::Models::Rate, MetronomeSDK::Internal::AnyHash),
              ...
              ending_before: Time,
              override_rate: T.any(MetronomeSDK::Models::Rate, MetronomeSDK::Internal::AnyHash),
          ...
          class CommitRate < MetronomeSDK::Internal::Type::BaseModel
            ...
            sig do
              params(
                rate_type: MetronomeSDK::Models::V1::ContractRetrieveRateScheduleResponse::Data::CommitRate::RateType::OrSymbol,
                price: Float,
            ...
            sig do
              override
                .returns(
                  {
                    rate_type: MetronomeSDK::Models::V1::ContractRetrieveRateScheduleResponse::Data::CommitRate::RateType::TaggedSymbol,
                    price: Float,
            ...
            module RateType
              ...
              TaggedSymbol =
                T.type_alias { T.all(Symbol, MetronomeSDK::Models::V1::ContractRetrieveRateScheduleResponse::Data::CommitRate::RateType) }
              ...
              sig do
                override
                  .returns(
                    T::Array[MetronomeSDK::Models::V1::ContractRetrieveRateScheduleResponse::Data::CommitRate::RateType::TaggedSymbol]
                  )
              end
              def self.values; end
            end
