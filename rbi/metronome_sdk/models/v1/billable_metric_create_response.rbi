  ...
  module Models
    module V1
      class BillableMetricCreateResponse < MetronomeSDK::Internal::Type::BaseModel
        ...
        sig do
          returns(MetronomeSDK::Models::V1::BillableMetricCreateResponse::Data)
        end
        attr_reader :data
        ...
        sig do
          params(
            data:
              MetronomeSDK::Models::V1::BillableMetricCreateResponse::Data::OrHash
          ).void
        end
        attr_writer :data
        ...
        class Data < MetronomeSDK::Internal::Type::BaseModel
          OrHash =
            T.type_alias do
              T.any(
                MetronomeSDK::Models::V1::BillableMetricCreateResponse::Data,
                MetronomeSDK::Internal::AnyHash
              )
            end
