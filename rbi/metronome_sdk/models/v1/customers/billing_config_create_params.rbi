      ...
      module Customers
        class BillingConfigCreateParams < MetronomeSDK::Internal::Type::BaseModel
          ...
          OrHash =
            T.type_alias do
              T.any(
                MetronomeSDK::V1::Customers::BillingConfigCreateParams,
          ...
          module BillingProviderType
            ...
            TaggedSymbol =
              T.type_alias do
                T.all(
                  Symbol,
                  MetronomeSDK::V1::Customers::BillingConfigCreateParams::BillingProviderType
                )
              end
          ...
          module AwsRegion
            ...
            TaggedSymbol =
              T.type_alias do
                T.all(
                  Symbol,
                  MetronomeSDK::V1::Customers::BillingConfigCreateParams::AwsRegion
                )
              end
            OrSymbol = T.type_alias { T.any(Symbol, String) }
            ...
            AF_SOUTH_1 =
              T.let(
                :"af-south-1",
                MetronomeSDK::V1::Customers::BillingConfigCreateParams::AwsRegion::TaggedSymbol
              )
            AP_EAST_1 =
              T.let(
                :"ap-east-1",
          ...
          module StripeCollectionMethod
            ...
            TaggedSymbol =
              T.type_alias do
                T.all(
                  Symbol,
                  MetronomeSDK::V1::Customers::BillingConfigCreateParams::StripeCollectionMethod
                )
              end
            OrSymbol = T.type_alias { T.any(Symbol, String) }
