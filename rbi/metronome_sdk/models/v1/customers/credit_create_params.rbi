        ...
        class CreditCreateParams < MetronomeSDK::Internal::Type::BaseModel
          ...
          class AccessSchedule < MetronomeSDK::Internal::Type::BaseModel
            ...
            sig do
              returns(
                T.nilable(
                  MetronomeSDK::V1::Customers::CreditCreateParams::AccessSchedule::AccessType::OrSymbol
                )
              )
            end
            ...
            module AccessType
              ...
              TaggedSymbol =
                T.type_alias do
                  T.all(
                    Symbol,
                    MetronomeSDK::V1::Customers::CreditCreateParams::AccessSchedule::AccessType
                  )
                end
              ...
              SPEND =
                T.let(
                  :SPEND,
                  MetronomeSDK::V1::Customers::CreditCreateParams::AccessSchedule::AccessType::TaggedSymbol
                )
              QUANTITY =
                T.let(
                  :QUANTITY,
