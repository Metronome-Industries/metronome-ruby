        ...
        class CommitCreateParams < MetronomeSDK::Internal::Type::BaseModel
          ...
          class AccessSchedule < MetronomeSDK::Internal::Type::BaseModel
            ...
            sig do
              returns(
                T.nilable(
                  MetronomeSDK::V1::Customers::CommitCreateParams::AccessSchedule::AccessType::OrSymbol
                )
              )
            end
            ...
            module AccessType
              ...
              TaggedSymbol =
                T.type_alias do
                  T.all(
                    Symbol,
                    MetronomeSDK::V1::Customers::CommitCreateParams::AccessSchedule::AccessType
                  )
                end
              ...
              SPEND =
                T.let(
                  :SPEND,
                  MetronomeSDK::V1::Customers::CommitCreateParams::AccessSchedule::AccessType::TaggedSymbol
                )
              QUANTITY =
                T.let(
                  :QUANTITY,
