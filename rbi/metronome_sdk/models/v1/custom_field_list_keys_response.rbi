    ...
    module V1
      class CustomFieldListKeysResponse < MetronomeSDK::Internal::Type::BaseModel
        ...
        sig do
          returns(
            T::Array[
              MetronomeSDK::Models::V1::CustomFieldListKeysResponse::Data
            ]
          )
        end
        attr_accessor :data
        ...
        sig do
          params(
            data:
              T::Array[
                MetronomeSDK::Models::V1::CustomFieldListKeysResponse::Data::OrHash
              ],
        ...
        class Data < MetronomeSDK::Internal::Type::BaseModel
          ...
          sig do
            params(
              ...
              entity:
                MetronomeSDK::Models::V1::CustomFieldListKeysResponse::Data::Entity::OrSymbol,
              key: String
            ).returns(T.attached_class)
          end
          ...
          module Entity
            ...
            TaggedSymbol =
              T.type_alias do
                T.all(
                  Symbol,
                  MetronomeSDK::Models::V1::CustomFieldListKeysResponse::Data::Entity
                )
              end
