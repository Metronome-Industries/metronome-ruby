  ...
  module Models
    module V1
      class CustomerCreateResponse < MetronomeSDK::Internal::Type::BaseModel
        ...
        sig { returns(MetronomeSDK::Models::V1::CustomerCreateResponse::Data) }
        attr_reader :data

        sig do
          params(
            data: MetronomeSDK::Models::V1::CustomerCreateResponse::Data::OrHash
          ).void
        end
        attr_writer :data
        ...
        class Data < MetronomeSDK::Internal::Type::BaseModel
          OrHash =
            T.type_alias do
              T.any(
                MetronomeSDK::Models::V1::CustomerCreateResponse::Data,
                MetronomeSDK::Internal::AnyHash
              )
            end
