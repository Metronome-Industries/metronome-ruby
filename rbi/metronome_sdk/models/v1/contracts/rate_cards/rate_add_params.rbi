        ...
        module RateCards
          class RateAddParams < MetronomeSDK::Internal::Type::BaseModel
            ...
            OrHash =
              T.type_alias do
                T.any(
                  MetronomeSDK::V1::Contracts::RateCards::RateAddParams,
            ...
            sig do
              returns(
                T.nilable(
                  T::Array[
                    MetronomeSDK::V1::Contracts::RateCards::RateAddParams::Tier
                  ]
                )
              )
            end
            ...
            module RateType
              ...
              TaggedSymbol =
                T.type_alias do
                  T.all(
                    Symbol,
                    MetronomeSDK::V1::Contracts::RateCards::RateAddParams::RateType
                  )
                end
              ...
              FLAT =
                T.let(
                  :FLAT,
                  MetronomeSDK::V1::Contracts::RateCards::RateAddParams::RateType::TaggedSymbol
                )
              PERCENTAGE =
                T.let(
                  :PERCENTAGE,
            ...
            module BillingFrequency
              ...
              TaggedSymbol =
                T.type_alias do
                  T.all(
                    Symbol,
                    MetronomeSDK::V1::Contracts::RateCards::RateAddParams::BillingFrequency
                  )
                end
              OrSymbol = T.type_alias { T.any(Symbol, String) }
              ...
              MONTHLY =
                T.let(
                  :MONTHLY,
                  MetronomeSDK::V1::Contracts::RateCards::RateAddParams::BillingFrequency::TaggedSymbol
                )
              QUARTERLY =
                T.let(
                  :QUARTERLY,
            ...
            class CommitRate < MetronomeSDK::Internal::Type::BaseModel
              ...
              sig do
                returns(
                  MetronomeSDK::V1::Contracts::RateCards::RateAddParams::CommitRate::RateType::OrSymbol
                )
              end
              attr_accessor :rate_type
              ...
              sig do
                returns(
                  T.nilable(
                    T::Array[
                      MetronomeSDK::V1::Contracts::RateCards::RateAddParams::CommitRate::Tier
                    ]
                  )
                )
              end
              ...
              sig do
                params(
                  tiers:
                    T::Array[
                      MetronomeSDK::V1::Contracts::RateCards::RateAddParams::CommitRate::Tier::OrHash
                    ]
                ).void
              end
              attr_writer :tiers
              ...
              module RateType
                ...
                FLAT =
                  T.let(
                    :FLAT,
                    MetronomeSDK::V1::Contracts::RateCards::RateAddParams::CommitRate::RateType::TaggedSymbol
                  )
                PERCENTAGE =
                  T.let(
                    :PERCENTAGE,
