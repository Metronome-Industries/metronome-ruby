          ...
          module SqlBreakdownGranularity
            ...
            TaggedSymbol =
              T.type_alias do
                T.all(
                  Symbol,
                  MetronomeSDK::V1::Contracts::ProductCreateParams::SqlBreakdownGranularity
                )
              end
            OrSymbol = T.type_alias { T.any(Symbol, String) }
            ...
            HOUR =
              T.let(
                :HOUR,
                MetronomeSDK::V1::Contracts::ProductCreateParams::SqlBreakdownGranularity::TaggedSymbol
              )
            SERVICE_PERIOD =
              T.let(
                :SERVICE_PERIOD,
