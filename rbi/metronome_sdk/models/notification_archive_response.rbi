  ...
  module Models
    class NotificationArchiveResponse < MetronomeSDK::Internal::Type::BaseModel
      OrHash =
        T.type_alias do
          T.any(
            MetronomeSDK::Models::NotificationArchiveResponse,
            MetronomeSDK::Internal::AnyHash
          )
        end

      sig { returns(MetronomeSDK::Models::NotificationArchiveResponse::Data) }
      attr_reader :data

      sig do
        params(
          data: MetronomeSDK::Models::NotificationArchiveResponse::Data::OrHash
        ).void
      end
      attr_writer :data
      ...
      class Data < MetronomeSDK::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              MetronomeSDK::Models::NotificationArchiveResponse::Data,
              MetronomeSDK::Internal::AnyHash
            )
          end
        ...
        sig do
          returns(
            MetronomeSDK::Models::NotificationArchiveResponse::Data::Policy
          )
        end
        attr_reader :policy
        ...
        sig do
          params(
            policy:
              MetronomeSDK::Models::NotificationArchiveResponse::Data::Policy::OrHash
          ).void
        end
        attr_writer :policy
