      ...
      class CustomerBillingProviderConfiguration < MetronomeSDK::Internal::Type::BaseModel
        ...
        sig do
          returns(
            T.nilable(
              T::Array[
                MetronomeSDK::Contract::CustomerBillingProviderConfiguration::UnbillableInvoicesConfiguration
              ]
            )
          )
        end
        ...
        sig do
          params(
            unbillable_invoices_configuration:
              T::Array[
                MetronomeSDK::Contract::CustomerBillingProviderConfiguration::UnbillableInvoicesConfiguration::OrHash
              ]
          ).void
        end
        ...
        class UnbillableInvoicesConfiguration < MetronomeSDK::Internal::Type::BaseModel
          ...
          sig do
            returns(
              MetronomeSDK::Contract::CustomerBillingProviderConfiguration::UnbillableInvoicesConfiguration::InvoiceType::TaggedSymbol
            )
          end
          ...
          sig do
            params(
              invoice_type:
                MetronomeSDK::Contract::CustomerBillingProviderConfiguration::UnbillableInvoicesConfiguration::InvoiceType::OrSymbol,
          ...
          module InvoiceType
            ...
            TaggedSymbol =
              T.type_alias do
                T.all(
                  Symbol,
                  MetronomeSDK::Contract::CustomerBillingProviderConfiguration::UnbillableInvoicesConfiguration::InvoiceType
                )
              end
            OrSymbol = T.type_alias { T.any(Symbol, String) }
