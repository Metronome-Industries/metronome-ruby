...
module MetronomeSDK
  module Models
    class PaymentListResponse < MetronomeSDK::Internal::Type::BaseModel
      ...
      sig do
        returns(
          T.nilable(MetronomeSDK::Models::PaymentListResponse::PaymentGateway)
        )
      end
      ...
      sig do
        params(
          payment_gateway:
            MetronomeSDK::Models::PaymentListResponse::PaymentGateway::OrHash
        ).void
      end
      ...
      sig do
        returns(
          T.nilable(
            MetronomeSDK::Models::PaymentListResponse::Status::TaggedSymbol
          )
        )
      end
      attr_reader :status
      ...
      sig do
        params(
          status: MetronomeSDK::Models::PaymentListResponse::Status::OrSymbol
        ).void
      end
      attr_writer :status
      ...
      class PaymentGateway < MetronomeSDK::Internal::Type::BaseModel
        ...
        sig do
          returns(
            MetronomeSDK::Models::PaymentListResponse::PaymentGateway::Stripe
          )
        end
        attr_reader :stripe
        ...
        sig do
          params(
            stripe:
              MetronomeSDK::Models::PaymentListResponse::PaymentGateway::Stripe::OrHash
          ).void
        end
        attr_writer :stripe
        ...
        sig do
          returns(
            MetronomeSDK::Models::PaymentListResponse::PaymentGateway::Type::TaggedSymbol
          )
        end
        attr_accessor :type
        ...
        sig do
          params(
            stripe:
              MetronomeSDK::Models::PaymentListResponse::PaymentGateway::Stripe::OrHash,
            type:
              MetronomeSDK::Models::PaymentListResponse::PaymentGateway::Type::OrSymbol
          ).returns(T.attached_class)
        end
        ...
        class Stripe < MetronomeSDK::Internal::Type::BaseModel
          ...
          sig do
            params(
              error:
                MetronomeSDK::Models::PaymentListResponse::PaymentGateway::Stripe::Error::OrHash
            ).void
          end
          attr_writer :error
          ...
          class Error < MetronomeSDK::Internal::Type::BaseModel
            ...
            sig do
              params(code: String, decline_code: String, type: String).returns(
                T.attached_class
              )
            end
        ...
        module Type
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(
                Symbol,
                MetronomeSDK::Models::PaymentListResponse::PaymentGateway::Type
              )
            end
      ...
      module Status
        ...
        TaggedSymbol =
          T.type_alias do
            T.all(Symbol, MetronomeSDK::Models::PaymentListResponse::Status)
          end
        OrSymbol = T.type_alias { T.any(Symbol, String) }
