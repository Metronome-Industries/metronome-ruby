  ...
  module Internal
    module Transport
      ...
      class BaseClient
        ...
        class << self
          # @api private
          sig { params(req: MetronomeSDK::Internal::Transport::BaseClient::RequestComponentsShape).void }
          ...
          sig do
            params(
              request: MetronomeSDK::Internal::Transport::BaseClient::RequestInputShape,
              status: Integer,
              response_headers: T.any(T::Hash[String, String], Net::HTTPHeader)
            )
              .returns(MetronomeSDK::Internal::Transport::BaseClient::RequestInputShape)
          end
          ...
          sig do
            params(
              status: T.any(Integer, MetronomeSDK::Errors::APIConnectionError),
        ...
        # @api private
        sig { returns(MetronomeSDK::Internal::Transport::PooledNetRequester) }
        ...
        sig do
          overridable
            .params(
              req: MetronomeSDK::Internal::Transport::BaseClient::RequestComponentsShape,
              opts: MetronomeSDK::Internal::AnyHash
            )
            .returns(MetronomeSDK::Internal::Transport::BaseClient::RequestInputShape)
        end
        ...
        def request(
          ...
          page: nil,
          stream: nil,
          model: MetronomeSDK::Internal::Type::Unknown,
          options: {}
        ); end
        # @api private
        sig { returns(String) }
