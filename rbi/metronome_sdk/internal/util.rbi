  ...
  module Internal
    ...
    module Util
      ...
      class << self
        ...
        sig do
          params(
            data: T.any(MetronomeSDK::Internal::AnyHash, T::Array[T.anything], T.anything),
            pick: T.nilable(
              T.any(
                Symbol,
                Integer,
      ...
      class << self
        # @api private
        sig { params(url: T.any(URI::Generic, String)).returns(MetronomeSDK::Internal::Util::ParsedUriShape) }
        def parse_uri(url); end

        # @api private
        sig { params(parsed: MetronomeSDK::Internal::Util::ParsedUriShape).returns(URI::Generic) }
        def unparse_uri(parsed); end

        # @api private
        sig do
          params(
            lhs: MetronomeSDK::Internal::Util::ParsedUriShape,
            rhs: MetronomeSDK::Internal::Util::ParsedUriShape
          )
            .returns(URI::Generic)
        end
      ...
      class << self
        ...
        sig do
          params(lines: T::Enumerable[String]).returns(T::Enumerable[MetronomeSDK::Internal::Util::ServerSentEvent])
        end
