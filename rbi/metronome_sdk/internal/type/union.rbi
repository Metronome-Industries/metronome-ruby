  ...
  module Internal
    module Type
      ...
      module Union
        ...
        sig do
          params(
            key: T.any(Symbol, MetronomeSDK::Internal::AnyHash, T.proc.returns(T.anything), T.anything),
            spec: T.any(MetronomeSDK::Internal::AnyHash, T.proc.returns(T.anything), T.anything)
          )
            .void
        end
        ...
        sig do
          override
            .params(value: T.anything, state: MetronomeSDK::Internal::Type::Converter::CoerceState)
            .returns(T.anything)
        end
        ...
        sig do
          override
            .params(value: T.anything, state: MetronomeSDK::Internal::Type::Converter::DumpState)
            .returns(T.anything)
        end
