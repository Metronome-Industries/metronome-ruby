...
module MetronomeSDK
  RequestOpts = T.type_alias { T.any(MetronomeSDK::RequestOptions, MetronomeSDK::Internal::AnyHash) }
  ...
  class RequestOptions < MetronomeSDK::Internal::Type::BaseModel
    ...
    sig { params(values: MetronomeSDK::Internal::AnyHash).returns(T.attached_class) }
